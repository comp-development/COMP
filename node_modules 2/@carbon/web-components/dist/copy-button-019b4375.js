 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let v=class extends p{constructor(){super(...arguments),this._showFeedback=!1,this._animation="",this._createHandleFeedbackTooltip=()=>{let e;return o=>{var t,n;const c=null===(n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("button"))||void 0===n?void 0:n.classList;e&&(clearTimeout(e),e=void 0),this._showFeedback=!0,null==c||c.add(`${s}--copy-btn--animating`),this._animation="fade-in",null==c||c.add(`${s}--copy-btn--${this._animation}`),this.requestUpdate(),e=setTimeout((()=>{this._showFeedback=!1,this._animation="fade-out",null==c||c.remove(`${s}--copy-btn--fade-in`),null==c||c.add(`${s}--copy-btn--${this._animation}`),this.requestUpdate()}),o)}},this._handleFeedbackTooltip=this._createHandleFeedbackTooltip(),this.feedback="Copied!",this.feedbackTimeout=2e3}_handleClickButton(){this._handleFeedbackTooltip(this.feedbackTimeout)}_renderTooltipContent(){return n`
      <cds-tooltip-content>
        ${this._showFeedback?this.feedback:n`<slot name="tooltip-content"></slot>`}
      </cds-tooltip-content>
    `}connectedCallback(){this.closeOnActivation=!1,this.align="bottom",this.addEventListener("click",this._handleClickButton),super.connectedCallback()}updated(e){var o,t,n,c,r;null===(t=null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector("button"))||void 0===t||t.addEventListener("animationend",(()=>{var e,o;if("fade-out"===this._animation){const t=null===(o=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("button"))||void 0===o?void 0:o.classList;null==t||t.remove(`${s}--copy-btn--animating`),null==t||t.remove(`${s}--copy-btn--${this._animation}`),this._animation=""}})),super.updated(e),null===(c=null===(n=this.shadowRoot)||void 0===n?void 0:n.querySelector("button"))||void 0===c||c.setAttribute("aria-label",null===(r=this.parentNode)||void 0===r?void 0:r.host.textContent)}};v.styles=l,t([r()],v.prototype,"feedback",void 0),t([r({type:Number,attribute:"feedback-timeout"})],v.prototype,"feedbackTimeout",void 0),v=t([i(`${s}-copy`)],v);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let b=class extends(a(c)){constructor(){super(...arguments),this.disabled=!1,this.feedback="Copied!",this.feedbackTimeout=2e3}render(){const{buttonClassName:o,disabled:t,feedback:c,feedbackTimeout:r}=this;let i=`${s}--copy-btn`;return o&&(i+=` ${o}`),n`
      <cds-copy
        ?disabled=${t}
        feedback=${c}
        feedback-timeout=${r}
        button-class-name=${i}>
        ${(({children:o,...t}={})=>e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${d(t)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${o}<path d="M28,10V28H10V10H28m0-2H10a2,2,0,0,0-2,2V28a2,2,0,0,0,2,2H28a2,2,0,0,0,2-2V10a2,2,0,0,0-2-2Z"></path><path d="M4,18H2V4A2,2,0,0,1,4,2H18V4H4Z"></path></svg>`)({slot:"icon",class:`${s}--snippet__icon`})}
        <slot slot="tooltip-content"></slot>
      </cds-copy>
    `}};b.styles=l,t([r({reflect:!0,attribute:"button-class-name"})],b.prototype,"buttonClassName",void 0),t([r({type:Boolean,reflect:!0})],b.prototype,"disabled",void 0),t([r()],b.prototype,"feedback",void 0),t([r({type:Number,attribute:"feedback-timeout"})],b.prototype,"feedbackTimeout",void 0),b=t([i(`${s}-copy-button`)],b);
