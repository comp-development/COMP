 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let g=class extends u{constructor(){super(...arguments),this.id="",this.pattern="",this.required=!1,this.rows=4}_handleInput({target:e}){this.value=e.value}render(){var e;const{enableCounter:t,maxCount:a}=this,r=null===(e=this.value)||void 0===e?void 0:e.length,d=l({class:`${s}--text-area__invalid-icon`}),u=c({class:`${s}--text-area__invalid-icon ${s}--text-area__invalid-icon--warning`}),m=n({[`${s}--text-area`]:!0,[`${s}--text-area--warn`]:this.warn,[`${s}--text-area--invalid`]:this.invalid}),h=n({[`${s}--text-area__wrapper`]:!0,[`${s}--text-area__wrapper--warn`]:this.warn,[`${s}--text-area__wrapper--readonly`]:this.readonly,[`${s}--text-area__wrapper--slug`]:this._hasAILabel}),g=n({[`${s}--label`]:!0,[`${s}--label--disabled`]:this.disabled}),v=n({[`${s}--form__helper-text`]:!0,[`${s}--form__helper-text--disabled`]:this.disabled}),y=t&&a?i` <label class="${g}">
            <slot name="label-text">${r}/${a}</slot>
          </label>`:null;return i`
      <div class="${s}--text-area__label-wrapper">
        ${this.hideLabel?i``:i`
              <label class="${g}" for="input">
                <slot name="label-text"> ${this.label} </slot>
              </label>
            `}
        ${y}
      </div>
      <div class="${h}" ?data-invalid="${this.invalid}">
        ${(()=>this.invalid?d:this.warn&&!this.invalid?u:null)()}
        <textarea
          ...
          rows="${p(this.rows)}"
          .value="${this.value}"
          maxlength="${o(this.maxCount)}"
          @input="${this._handleInput}"></textarea>
        <slot name="ai-label" @slotchange="${this._handleSlotChange}"></slot>
        <slot name="slug" @slotchange="${this._handleSlotChange}"></slot>
      </div>
      <div class="${v}" ?hidden="${this.invalid||this.warn}">
    ...
    `}};g.shadowRootOptions=Object.assign(Object.assign({},t.shadowRootOptions),{delegatesFocus:!0}),g.styles=h,a([r({type:Number})],g.prototype,"cols",void 0),a([r()],g.prototype,"id",void 0),a([r()],g.prototype,"pattern",void 0),a([r({type:Boolean,reflect:!0})],g.prototype,"required",void 0),a([r()],g.prototype,"rows",void 0),a([d("textarea")],g.prototype,"_textarea",void 0),g=a([m(`${s}-textarea`)],g);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends t{render(){return i`
      <span class="${s}--label ${s}--skeleton"></span>
      <div class="${s}--skeleton ${s}--text-area"></div>
    `}};v.styles=h,v=a([m(`${s}-textarea-skeleton`)],v);
