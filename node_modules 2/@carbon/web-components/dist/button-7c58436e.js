...
import{i as o,p as t,x as e,s,_ as n}from"./settings-1096a273.js";import{e as c}from"./class-map-f136ab55.js";import{o as d}from"./if-defined-7d77967b.js";import{n as r}from"./property-8bf17a69.js";import{F as i}from"./focus-a50a0482.js";import{H as a,a as p}from"./host-listener-69c546a1.js";import{c as l}from"./carbon-element-017b212d.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let m=class extends(a(i(s))){constructor(){super(...arguments),this._hasIcon=!1,this._handleOver=()=>{this.openTooltip=!0},this._handleHoverOut=async()=>{this.openTooltip=!1},this._handleFocus=async()=>{this.openTooltip=!0},this._handleFocusout=async()=>{this.openTooltip=!1},this.autofocus=!1,this.batchAction=!1,this.disabled=!1,this.hasMainContent=!1,this.isExpressive=!1,this.isSelected=!1,this.kind=b.PRIMARY,this.linkRole="button",this.openTooltip=!1,this.size="lg",this.tooltipAlignment=g.CENTER,this.tooltipPosition=u.TOP,this.type=v.BUTTON}_handleSlotChange({target:o}){const{name:t}=o,e=o.assignedNodes().some((o=>o.nodeType!==Node.TEXT_NODE||o.textContent.trim()));this["icon"===t?"_hasIcon":"hasMainContent"]=e,this.requestUpdate()}_handleDisabledClick(o){const{disabled:t}=this;t&&o.stopPropagation()}render(){const{autofocus:o,buttonClassName:s,dangerDescriptor:n,disabled:r,download:i,href:a,hreflang:p,kind:l,isExpressive:v,isSelected:h,linkRole:g,openTooltip:f,ping:m,rel:y,size:x,target:z,tooltipAlignment:k,tooltipPosition:_,tooltipText:w,type:$,_hasIcon:T,hasMainContent:S,_handleSlotChange:R}=this;let M={[`${t}--btn`]:!0,[`${t}--btn--${l}`]:l,[`${t}--btn--danger--tertiary`]:l===b.DANGER_TERTIARY,[`${t}--btn--danger--ghost`]:l===b.DANGER_GHOST,[`${t}--btn--disabled`]:r,[`${t}--btn--icon-only`]:T&&!S,[`${t}--btn--${x}`]:x,[`${t}--layout--size-${x}`]:x,[`${t}-ce--btn--has-icon`]:T,[`${t}--btn--expressive`]:v,[`${t}--btn--selected`]:h&&"ghost"===l};if(s){const o={};null==s||s.split(" ").forEach((t=>{o[t]=!0})),M=Object.assign(Object.assign({},M),o)}const B=c(M),E=l.includes("danger");if(a)return r?e`
          ...
          `;const F=!k||_!==u.TOP&&_!==u.BOTTOM?"":`-${k}`,N=c({[`${t}--popover-container`]:!0,[`${t}--popover--caret`]:!0,[`${t}--popover--high-contrast`]:!0,[`${t}--tooltip`]:!0,[`${t}--icon-tooltip`]:T,[`${t}--popover--open`]:f,[`${t}--popover--${_}${F}`]:w});return w&&!r?e`
          <span class="${N}">
            <button
              id="button"
              part="button"
            ...
            <span class="${t}--popover">
              <span
                class="${t}--popover-content ${t}--tooltip-content">
                ${w}
              </span>
              <span class="${t}--popover-caret"></span>
            </span>
          </span>
        `:e`
          <button
            ...
            ?disabled="${r}"
            type="${d($)}">
            ${E?e`<span class="${t}--visually-hidden"
                  >${n}</span
                >`:""}
            <slot @slotchange="${R}"></slot>
            <slot name="icon" @slotchange="${R}"></slot>
          </button>
        `}};m.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),m.styles=f,n([p("click",{capture:!0})],m.prototype,"_handleDisabledClick",null),n([p("mouseover")],m.prototype,"_handleOver",void 0),n([p("mouseout")],m.prototype,"_handleHoverOut",void 0),n([p("focus")],m.prototype,"_handleFocus",void 0),n([p("focusout")],m.prototype,"_handleFocusout",void 0),n([r({type:Boolean,reflect:!0})],m.prototype,"autofocus",void 0),n([r({type:Boolean,reflect:!0,attribute:"batch-action"})],m.prototype,"batchAction",void 0),n([r({reflect:!0,attribute:"button-class-name"})],m.prototype,"buttonClassName",void 0),n([r({reflect:!0,attribute:"danger-descriptor"})],m.prototype,"dangerDescriptor",void 0),n([r({type:Boolean,reflect:!0})],m.prototype,"disabled",void 0),n([r({reflect:!0})],m.prototype,"download",void 0),n([r({reflect:!0,attribute:"has-main-content",type:Boolean})],m.prototype,"hasMainContent",void 0),n([r({reflect:!0})],m.prototype,"href",void 0),n([r({reflect:!0})],m.prototype,"hreflang",void 0),n([r({type:Boolean,reflect:!0})],m.prototype,"isExpressive",void 0),n([r({type:Boolean,reflect:!0})],m.prototype,"isSelected",void 0),n([r({reflect:!0})],m.prototype,"kind",void 0),n([r({attribute:"link-role"})],m.prototype,"linkRole",void 0),n([r({type:Boolean})],m.prototype,"openTooltip",void 0),n([r({reflect:!0})],m.prototype,"ping",void 0),n([r({reflect:!0})],m.prototype,"rel",void 0),n([r({reflect:!0})],m.prototype,"size",void 0),n([r({reflect:!0})],m.prototype,"target",void 0),n([r({reflect:!0,attribute:"tooltip-alignment"})],m.prototype,"tooltipAlignment",void 0),n([r({reflect:!0,attribute:"tooltip-position"})],m.prototype,"tooltipPosition",void 0),n([r({reflect:!0,attribute:"tooltip-text"})],m.prototype,"tooltipText",void 0),n([r({reflect:!0})],m.prototype,"type",void 0),m=n([l(`${t}-button`)],m);var y=m;export{b as B,y as C,h as a,f as b,u as c};
