...
import{i as o,_ as t,s as e,p as s,x as n}from"./settings-1096a273.js";import{n as c}from"./property-8bf17a69.js";import{c as d}from"./carbon-element-017b212d.js";import"./button-7c58436e.js";import{e as r}from"./class-map-f136ab55.js";import"./if-defined-7d77967b.js";import"./focus-a50a0482.js";import"./host-listener-69c546a1.js";import"./on-8707857f.js";import"./directive-e2d48b9c.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=class extends e{constructor(){super(...arguments),this._hasIcon=!1,this.disabled=!1,this.kind=a.PRIMARY,this.size=i.LARGE,this.isQuickAction=!1,this.isSelected=!1}_handleSlotChange({target:o}){this._hasIcon=o.assignedNodes().some((o=>o.nodeType!==Node.TEXT_NODE||o.textContent.trim())),this.requestUpdate()}render(){const o=[i.SMALL,i.MEDIUM,i.LARGE];this.isQuickAction?(this.kind=a.GHOST,this.size=i.SMALL):this.size=o.includes(this.size)?this.size:i.LARGE;let t=`${s}--chat-btn`;return t+=this._hasIcon?` ${s}--chat-btn--with-icon`:"",t+=this.isQuickAction?` ${s}--chat-btn--quick-action`:"",t+=this.isSelected?` ${s}--chat-btn--quick-action--selected`:"",n`
      <cds-button
        button-class-name="${t}"
        size="${this.size}"
        kind="${this.kind}"
    ...
    `}};l.styles=p,t([c({type:Boolean,reflect:!0})],l.prototype,"disabled",void 0),t([c({reflect:!0})],l.prototype,"kind",void 0),t([c({reflect:!0})],l.prototype,"size",void 0),t([c({attribute:"is-quick-action",type:Boolean})],l.prototype,"isQuickAction",void 0),t([c({attribute:"is-selected",type:Boolean})],l.prototype,"isSelected",void 0),l=t([d(`${s}-chat-button`)],l);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let b=class extends e{constructor(){super(...arguments),this.size=i.LARGE}render(){const o=r({[`${s}--skeleton`]:!0,[`${s}--btn`]:!0,[`${s}--chat-btn`]:!0,[`${s}--layout--size-${this.size}`]:this.size});return n` <div class="${o}"></div> `}};b.styles=p,t([c({reflect:!0})],b.prototype,"size",void 0),b=t([d(`${s}-chat-button-skeleton`)],b);
