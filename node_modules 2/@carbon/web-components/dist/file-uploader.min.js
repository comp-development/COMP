 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let y=class extends t{constructor(){super(...arguments),this.disabled=!1,this.labelDescription="",this.labelTitle=""}updated(e){if(e.has("disabled")){const{selectorUploaderItem:e}=this.constructor;this.querySelector(e).disabled=this.disabled}}render(){const{disabled:e,labelDescription:o,labelTitle:t}=this,n=i({[`${r}--file--label`]:!0,[`${r}--label-description--disabled`]:e}),d=i({[`${r}--label-description`]:!0,[`${r}--label-description--disabled`]:e});return s`
      <p class="${n}">
        <slot name="label-title">${t}</slot>
      </p>
      <p class="${d}">
        <slot name="label-description">${o}</slot>
      </p>
      <slot name="drop-container"></slot>
      <div class="${r}--file-container">
        <slot></slot>
      </div>
    `}static get selectorUploaderItem(){return`${r}-file-uploader-button,${r}-file-uploader-drop-container`}};
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
var x,_;y.styles=h,o([n({type:Boolean,reflect:!0})],y.prototype,"disabled",void 0),o([n({attribute:"label-description"})],y.prototype,"labelDescription",void 0),o([n({attribute:"label-title"})],y.prototype,"labelTitle",void 0),y=o([d(`${r}-file-uploader`)],y),function(e){e.UPLOADING="uploading",e.COMPLETE="complete",e.EDIT="edit"}(x||(x={})),function(e){e.SMALL="sm",e.MEDIUM="md",e.LARGE="lg"}(_||(_={}));
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends t{constructor(){super(...arguments),this.iconDescription="Delete this file",this.invalid=!1,this.size=_.MEDIUM,this.state=x.UPLOADING,this.errorSubject="",this.errorBody=""}_handleClickDeleteButton(){const e={bubbles:!0,cancelable:!0,composed:!0},{eventBeforeDelete:o,eventDelete:t}=this.constructor;this.dispatchEvent(new CustomEvent(o,e))&&this.dispatchEvent(new CustomEvent(t,e))}_renderEditing(){const{iconDescription:e,invalid:o,_handleClickDeleteButton:t}=this;return s`
      ${o?l({class:`${r}--file-invalid`}):void 0}
      <button
        type="button"
        aria-label="${e}"
        class="${r}--file-close"
    ...
    `}_renderUploaded(){const{iconDescription:e}=this;return c({class:`${r}--file-complete`,"aria-label":e})}_renderStatus(){const{state:e}=this;switch(e){case x.EDIT:return this._renderEditing();case x.UPLOADING:return this._renderUploading();case x.COMPLETE:return this._renderUploaded();default:return}}render(){const{invalid:e,errorSubject:o,errorBody:t}=this;return s` <p class="${r}--file-filename"><slot></slot></p>
      <span class="${r}--file__state-container"
        >${this._renderStatus()}</span
      >
      <div
        class="${r}--form-requirement"
        ?hidden="${!e&&!o}">
        <div class="${r}--form-requirement__title">${o}</div>
        <p
          class="${r}--form-requirement__supplement"
          ?hidden="${!t}">
          ${t}
        </p>
      </div>`}static get eventBeforeDelete(){return`${r}-file-uploader-item-beingdeleted`}static get eventDelete(){return`${r}-file-uploader-item-deleted`}};z.styles=h,o([n({attribute:"icon-description"})],z.prototype,"iconDescription",void 0),o([n({type:Boolean,reflect:!0})],z.prototype,"invalid",void 0),o([n({reflect:!0})],z.prototype,"size",void 0),o([n({reflect:!0})],z.prototype,"state",void 0),o([n({attribute:"error-subject"})],z.prototype,"errorSubject",void 0),o([n({attribute:"error-body"})],z.prototype,"errorBody",void 0),z=o([d(`${r}-file-uploader-item`)],z);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
const k={dragover:"copy",dragleave:"move"};let w=class extends(v(t)){constructor(){super(...arguments),this._active=!1,this.accept="",this.disabled=!1,this.multiple=!1,this.name="",this.slot="drop-container"}_handleChange(e){var o,t;const{eventChange:s,selectorInput:r}=this.constructor,{files:i}=null!==(o="drop"===e.type?e.dataTransfer:e.target)&&void 0!==o?o:{},n=this._getFiles(e,i);this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0,detail:{addedFiles:n}}));const d=null===(t=null==this?void 0:this.shadowRoot)||void 0===t?void 0:t.querySelector(r);d&&(d.value="")}_handleDrag(e){if(e.preventDefault(),this.disabled)return;const{dataTransfer:o,type:t}=e,s=k[t];o&&s&&(o.dropEffect=s),this._active="dragover"===t,"drop"===t&&this._handleChange(e),this.requestUpdate()}_getFiles(e,o){const{accept:t}=this;if(!t||!/^(change|drop)$/.test(e.type))return Array.from(null!=o?o:[]);const s=new Set(t.split(" "));return Array.prototype.filter.call(o,(({name:e,type:o=""})=>{var t;const r=/\.[^.]+$/,i=r.test(e),[n]=i?null!==(t=r.exec(e))&&void 0!==t?t:[]:[void 0];return s.has(o)||n&&s.has(n)}))}render(){const{accept:e,disabled:o,multiple:t,name:n,_active:d,_handleChange:c}=this,a=i({[`${r}--file-browse-btn`]:!0,[`${r}--file-browse-btn--disabled`]:o}),l=i({[`${r}--file__drop-container`]:!0,[`${r}--file__drop-container--drag-over`]:d});return s`
    ...
    `}static get eventChange(){return`${r}-file-uploader-drop-container-changed`}static get selectorInput(){return`.${r}--file-input`}};w.styles=h,o([f("dragover"),f("dragleave"),f("drop")],w.prototype,"_handleDrag",null),o([n()],w.prototype,"accept",void 0),o([n({type:Boolean,reflect:!0})],w.prototype,"disabled",void 0),o([n({type:Boolean,reflect:!0})],w.prototype,"multiple",void 0),o([n({reflect:!0})],w.prototype,"name",void 0),o([n({reflect:!0})],w.prototype,"slot",void 0),w=o([d(`${r}-file-uploader-drop-container`)],w);
/**
 * @license
 *
 * Copyright IBM Corp. 2020, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let $=class extends(v(t)){constructor(){super(...arguments),this.buttonKind=m.PRIMARY,this.size=u.MEDIUM,this.accept="",this.disabled=!1,this.multiple=!1,this.name="",this.slot="drop-container"}_handleClick(e){var o,t,s;e.target.value=null;const{selectorInput:r}=this.constructor;null===(t=null===(o=null==this?void 0:this.shadowRoot)||void 0===o?void 0:o.querySelector(r))||void 0===t||t.setAttribute("value",""),(null===(s=null==this?void 0:this.shadowRoot)||void 0===s?void 0:s.querySelector(r)).click()}_handleKeyDown(e){var o,t,s;const{selectorInput:r}=this.constructor;"Enter"!==e.key&&"Space"!==e.key||(null===(t=null===(o=null==this?void 0:this.shadowRoot)||void 0===o?void 0:o.querySelector(r))||void 0===t||t.setAttribute("value",""),(null===(s=null==this?void 0:this.shadowRoot)||void 0===s?void 0:s.querySelector(r)).click())}_handleChange(e){var o;const t=this._getFiles(e),{eventChange:s,selectorInput:r}=this.constructor;this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0,detail:{addedFiles:t}}));const i=null===(o=null==this?void 0:this.shadowRoot)||void 0===o?void 0:o.querySelector(r);i&&(i.value="")}_getFiles(e){var o;const{files:t}=null!==(o="drop"===e.type?e.dataTransfer:e.target)&&void 0!==o?o:{},{accept:s}=this;if(!s||!/^(change|drop)$/.test(e.type))return Array.from(null!=t?t:[]);const r=new Set(s.split(" "));return Array.prototype.filter.call(t,(({name:e,type:o=""})=>{var t;const s=/\.[^.]+$/,i=s.test(e),[n]=i?null!==(t=s.exec(e))&&void 0!==t?t:[]:[void 0];return r.has(o)||n&&r.has(n)}))}render(){const{accept:e,disabled:o,multiple:t,name:n,buttonKind:d,size:c,_handleChange:a}=this,l=i({[`${r}--file-browse-btn`]:!0,[`${r}--file-browse-btn--disabled`]:o}),p=i({[`${r}--btn`]:!0,[`${r}--btn--${d}`]:d,[`${r}--layout--size-${c}`]:c,[`${r}--btn--disabled`]:o,[`${r}--btn--${c}`]:c});return s`
      <button
        type="button"
        class="${p}"
      ...
      <input
        ...
        name="${b(n)}"
        @change="${a}" />
    `}static get eventChange(){return`${r}-file-uploader-button-changed`}static get selectorInput(){return`.${r}--file-input`}};$.styles=h,o([n({reflect:!0,attribute:"button-kind"})],$.prototype,"buttonKind",void 0),o([n({reflect:!0})],$.prototype,"size",void 0),o([n()],$.prototype,"accept",void 0),o([n({type:Boolean,reflect:!0})],$.prototype,"disabled",void 0),o([n({type:Boolean,reflect:!0})],$.prototype,"multiple",void 0),o([n({reflect:!0})],$.prototype,"name",void 0),o([n({reflect:!0})],$.prototype,"slot",void 0),$=o([d(`${r}-file-uploader-button`)],$);
/**
 * @license
 *
