 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let x=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","banner"),super.connectedCallback()}render(){return s` <slot></slot> `}};x.styles=y,x=t([n(`${r}-header`)],x);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let k=class extends i{connectedCallback(){this.tooltipPosition=l.BOTTOM,super.connectedCallback()}_handleClick(e){const{disabled:t}=this;if(t)e.stopPropagation();else{const e=document.querySelector(`#${this.panelId}`);if(e){e.getAttribute("expanded")?e.removeAttribute("expanded"):e.setAttribute("expanded","true");const t=!this.active;this.active=t}}}updated(){this._buttonNode&&this._buttonNode.classList.add(`${r}--header__action`)}shouldUpdate(e){return e.has("active")&&(this.active?(this._buttonNode.classList.add(`${r}--header__action--active`),this.buttonLabelActive&&(this.tooltipText=this.buttonLabelActive)):(this._buttonNode.classList.remove(`${r}--header__action--active`),this.buttonLabelInactive&&(this.tooltipText=this.buttonLabelInactive))),!0}};k.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),k.styles=y,t([c("button")],k.prototype,"_buttonNode",void 0),t([a({type:Boolean,reflect:!0})],k.prototype,"active",void 0),t([a({type:String,attribute:"panel-id",reflect:!0})],k.prototype,"panelId",void 0),t([a({attribute:"button-label-active"})],k.prototype,"buttonLabelActive",void 0),t([a({attribute:"button-label-inactive"})],k.prototype,"buttonLabelInactive",void 0),t([p("click",{capture:!0})],k.prototype,"_handleClick",null),k=t([n(`${r}-header-global-action`)],k);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends(v(m(o))){constructor(){super(...arguments),this._hasActiveChildren=!1,this.expanded=!1,this.isActive=!1,this.triggerContent=""}_handleClick(){this._handleUserInitiatedToggle()}_handleKeydownTrigger({key:e}){"Esc"!==e&&"Escape"!==e||this._handleUserInitiatedToggle(!1)}_handleUserInitiatedToggle(e=!this.expanded){this.expanded=e,e||this._topMenuItem.focus()}_handleBlur({relatedTarget:e}){this.contains(e)||(this.expanded=!1)}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem");const{selectorItem:e}=this.constructor;g(this.querySelectorAll(e),(e=>{!0===e.isActive&&(this._hasActiveChildren=!0)})),super.connectedCallback()}updated(e){if(e.has("expanded")){const{selectorItem:e}=this.constructor,{expanded:t}=this;g(this.querySelectorAll(e),(e=>{e.tabIndex=t?0:-1}))}}render(){const{expanded:e,isActive:t,triggerContent:o,menuLabel:d,_hasActiveChildren:n,_handleClick:a}=this,c=u({[`${r}--header__menu-item`]:!0,[`${r}--header__menu-title`]:!0,[`${r}--header__menu-item--current`]:t||n&&!e});return s`
      <a
        part="trigger"
        role="button"
        tabindex="0"
        ...
        @click=${a}>
        ${o}${b({part:"trigger-icon",class:`${r}--header__menu-arrow`})}
      </a>
      <ul
        part="menu-body"
        class="${r}--header__menu"
        aria-label="${h(d)}">
        <slot></slot>
      </ul>
    `}static get selectorItem(){return`${r}-header-menu-item`}};z.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),z.styles=y,t([c('[part="trigger"]')],z.prototype,"_topMenuItem",void 0),t([p("keydown")],z.prototype,"_handleKeydownTrigger",null),t([p("focusout")],z.prototype,"_handleBlur",null),t([a({type:Boolean,reflect:!0})],z.prototype,"expanded",void 0),t([a({type:Boolean,attribute:"is-active",reflect:!0})],z.prototype,"isActive",void 0),t([a({attribute:"trigger-content"})],z.prototype,"triggerContent",void 0),t([a({attribute:"menu-label"})],z.prototype,"menuLabel",void 0),z=t([n(`${r}-header-menu`)],z);const w=({children:e,...t}={})=>d`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${f(t)}" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20">${e}<path d="M2 14.8H18V16H2zM2 11.2H18V12.399999999999999H2zM2 7.6H18V8.799999999999999H2zM2 4H18V5.2H2z"></path></svg>`
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let O=class extends(v(o)){constructor(){super(...arguments),this._hovered=!1,this._hTransition=null,this._handleButtonToggle=async e=>{this.expanded=e.detail.active},this.collapseMode=$.RESPONSIVE,this.expanded=!1,this.isNotChildOfHeader=!1,this.isNotPersistent=!1}_cleanHTransition(){this._hTransition&&(this._hTransition=this._hTransition.release())}_updatedSideNavMenuForceCollapsedState(){const{expanded:e,_hovered:t}=this;g(this.querySelectorAll(this.constructor.selectorMenu),(o=>{o.forceCollapsed=!e&&!t}))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}disconnectedCallback(){this._cleanHTransition(),super.disconnectedCallback()}updated(e){var t;const o=this.getRootNode();if(e.has("collapseMode")&&g(o.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.collapseMode=this.collapseMode})),e.has("expanded")){const e=o.querySelectorAll(this.constructor.selectorHeaderItems);g(o.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.active=this.expanded})),this.expanded?(g(e,(e=>{e.setAttribute("tabindex","-1")})),null===(t=this.querySelector(this.constructor.selectorNavItems))||void 0===t||t.focus()):g(e,(e=>{e.removeAttribute("tabindex")}))}e.has("isNotChildOfHeader")&&g(o.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.isNotChildOfHeader=this.isNotChildOfHeader}))}_handleFocusOut({relatedTarget:e}){const{collapseMode:t}=this;t!==$.FIXED&&(this.contains(e)||(this.expanded=!1))}_handleFocusIn(){const{collapseMode:e}=this;e!==$.FIXED&&(this.expanded=!0)}_handleNavMouseOver(){const{collapseMode:e}=this;e===$.RAIL&&(this.expanded=!0,this._hovered=!0,this._updatedSideNavMenuForceCollapsedState())}_handleNavMouseOut(){const{collapseMode:e}=this;e===$.RAIL&&(this.expanded=!1,this._hovered=!1,this._updatedSideNavMenuForceCollapsedState())}_onOverlayClick(){this.expanded=!1}render(){const{collapseMode:e,expanded:t,isNotChildOfHeader:o,isNotPersistent:d}=this,n=u({[`${r}--side-nav__navigation`]:!0,[`${r}--side-nav`]:!0,[`${r}--side-nav--expanded`]:t,[`${r}--side-nav--collapsed`]:!t&&e===$.FIXED,[`${r}--side-nav--rail`]:e===$.RAIL,[`${r}--side-nav--ux`]:!o,[`${r}--side-nav--hidden`]:d}),a=u({[`${r}--side-nav__overlay`]:!0,[`${r}--side-nav__overlay-active`]:t});return s`${this.collapseMode===$.FIXED?null:s`<div
            class="${a}"
      ...
      <div
        ...
        <slot></slot>
      </div>`}static get selectorButtonToggle(){return`${r}-header-menu-button`}static get selectorHeaderItems(){return`${r}-header-name, ${r}-header-global-action`}static get selectorNavItems(){return`${r}-side-nav-menu, ${r}-side-nav-menu-item, ${r}-side-nav-link`}static get selectorMenu(){return`${r}-side-nav-menu`}static get eventButtonToggle(){return`${r}-header-menu-button-toggled`}};O.styles=A,t([p("parentRoot:eventButtonToggle")],O.prototype,"_handleButtonToggle",void 0),t([a({reflect:!0,attribute:"collapse-mode"})],O.prototype,"collapseMode",void 0),t([a({type:Boolean,reflect:!0})],O.prototype,"expanded",void 0),t([a({type:Boolean,attribute:"is-not-child-of-header"})],O.prototype,"isNotChildOfHeader",void 0),t([a({type:Boolean,reflect:!0,attribute:"is-not-persistent"})],O.prototype,"isNotPersistent",void 0),t([p("focusout")],O.prototype,"_handleFocusOut",null),t([p("focusin")],O.prototype,"_handleFocusIn",null),O=t([n(`${r}-side-nav`)],O);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let I=class extends(m(o)){constructor(){super(...arguments),this.active=!1,this.buttonLabelActive="Close navigation menu",this.buttonLabelInactive="Open navigation menu",this.collapseMode=$.RESPONSIVE,this.disabled=!1,this.isNotChildOfHeader=!1}_handleClick(){const e=!this.active;this.active=e,this.dispatchEvent(new CustomEvent(this.constructor.eventToggle,{bubbles:!0,cancelable:!0,composed:!0,detail:{active:e}}))}render(){const{active:e,buttonLabelActive:t,buttonLabelInactive:o,disabled:d,_handleClick:n}=this,a=e?t:o,c=u({[`${r}--header__action`]:!0,[`${r}--header__menu-trigger`]:!0,[`${r}--header__menu-toggle`]:!0,[`${r}--header__action--active`]:e});return s`
      <button
        part="button"
        class="${c}"
        ?disabled=${d}
        aria-label="${h(a)}"
        @click=${n}>
        ${(e?_:w)({slot:"toggle-icon"})}
      </button>
    `}static get eventToggle(){return`${r}-header-menu-button-toggled`}};I.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),I.styles=y,t([a({type:Boolean,reflect:!0})],I.prototype,"active",void 0),t([a({attribute:"button-label-active"})],I.prototype,"buttonLabelActive",void 0),t([a({attribute:"button-label-inactive"})],I.prototype,"buttonLabelInactive",void 0),t([a({reflect:!0,attribute:"collapse-mode"})],I.prototype,"collapseMode",void 0),t([a({type:Boolean,reflect:!0})],I.prototype,"disabled",void 0),t([a({type:Boolean,attribute:"is-not-child-of-header"})],I.prototype,"isNotChildOfHeader",void 0),I=t([n(`${r}-header-menu-button`)],I);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let j=class extends(m(o)){constructor(){super(...arguments),this.isActive=!1,this.role="listitem"}render(){const{ariaCurrent:e,href:t,isActive:o,title:d,rel:n,target:a}=this,c=u({[`${r}--header__menu-item`]:!0,[`${r}--header__menu-item--current`]:o&&"page"!==e});return s`
      <a
        part="link"
        class="${c}"
        tabindex="0"
        ...
        rel="${h(n)}"
        target="${h(a)}">
        <span part="title" class="${r}--text-truncate--end"
          ><slot>${d}</slot></span
        >
      </a>
    `}};j.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),j.styles=y,t([a()],j.prototype,"href",void 0),t([a({reflect:!0})],j.prototype,"rel",void 0),t([a({reflect:!0})],j.prototype,"target",void 0),t([a()],j.prototype,"title",void 0),t([a({type:Boolean,attribute:"is-active"})],j.prototype,"isActive",void 0),t([a({type:String,attribute:"aria-current"})],j.prototype,"ariaCurrent",void 0),t([a({reflect:!0})],j.prototype,"role",void 0),j=t([n(`${r}-header-nav-item`)],j);var B=j;
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let N=class extends B{};N=t([n(`${r}-header-menu-item`)],N);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let T=class extends(m(o)){render(){const{href:e,prefix:t}=this,o=t?s`
          <span part="prefix" class="${r}--header__name--prefix"
            >${t}</span
          >
        `:void 0;return s`
      <a part="link" class="${r}--header__name" href="${h(e)}"
        >${o}&nbsp;<slot></slot
      ></a>
    `}};T.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),T.styles=y,t([a()],T.prototype,"href",void 0),t([a()],T.prototype,"prefix",void 0),T=t([n(`${r}-header-name`)],T);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let M=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}render(){const{menuBarLabel:e}=this;return s`
      <div part="divider" class="${r}-ce--header__divider"></div>
      <ul
        part="menu-body"
        class="${r}--header__menu-bar"
        aria-label="${e}">
        <slot></slot>
      </ul>
    `}};M.styles=y,t([a({attribute:"menu-bar-label"})],M.prototype,"menuBarLabel",void 0),M=t([n(`${r}-header-nav`)],M);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let S=class extends o{render(){return s`<slot></slot>`}};S.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),S.styles=y,t([a({type:Boolean,reflect:!0})],S.prototype,"expanded",void 0),S=t([n(`${r}-header-panel`)],S);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let R=class extends o{constructor(){super(...arguments),this.hasDivider=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return s`<slot></slot>`}};R.styles=A,t([a({type:Boolean,attribute:"has-divider"})],R.prototype,"hasDivider",void 0),R=t([n(`${r}-header-side-nav-items`)],R);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let L=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","separator"),super.connectedCallback()}};L.styles=A,L=t([n(`${r}-side-nav-divider`)],L);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let E=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return s`<slot></slot>`}};E.styles=A,E=t([n(`${r}-side-nav-items`)],E);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let H=class extends(m(o)){constructor(){super(...arguments),this.active=!1,this.href="",this.large=!1}_handleSlotChangeTitleIcon({target:e}){var t;null===(t=this._titleIconContainerNode)||void 0===t||t.toggleAttribute("hidden",0===e.assignedNodes().length)}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{active:e,href:t,rel:o,target:d,title:n,_handleSlotChangeTitleIcon:a}=this,c=u({[`${r}--side-nav__link`]:!0,[`${r}--side-nav__link--current`]:e});return s`
      <a
        part="link"
        class="${c}"
        href="${t}"
        ...
        <span part="title" class="${r}--side-nav__link-text">
          <slot>${n}</slot>
        </span>
      </a>
    `}};H.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),H.styles=A,t([c("#title-icon-container")],H.prototype,"_titleIconContainerNode",void 0),t([a({type:Boolean,reflect:!0})],H.prototype,"active",void 0),t([a()],H.prototype,"href",void 0),t([a({reflect:!0})],H.prototype,"rel",void 0),t([a({reflect:!0})],H.prototype,"target",void 0),t([a({type:Boolean,reflect:!0})],H.prototype,"large",void 0),t([a()],H.prototype,"title",void 0),H=t([n(`${r}-side-nav-link`)],H);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let F=class extends(m(o)){constructor(){super(...arguments),this._hasIcon=!1,this.active=!1,this.expanded=!1,this.large=!1,this.forceCollapsed=!1,this.title=""}_handleUserInitiatedToggle(e=!this.expanded){const{eventBeforeToggle:t,eventToggle:o}=this.constructor,s={bubbles:!0,cancelable:!0,composed:!0,detail:{expanded:e}};this.dispatchEvent(new CustomEvent(t,s))&&(this.expanded=e,this.dispatchEvent(new CustomEvent(o,s)))}_handleClickExpando(){this._handleUserInitiatedToggle()}_handleSlotChange({target:e}){const{_hasIcon:t}=this;g(e.assignedNodes(),(e=>{e.nodeType===Node.ELEMENT_NODE&&e.toggleAttribute(this.constructor.attribItemHasIcon,t)}))}_handleSlotChangeTitleIcon({target:e}){var t;const o=this.constructor,s=e.assignedNodes().length>0;this._hasIcon=s,null===(t=this._titleIconContainerNode)||void 0===t||t.toggleAttribute("hidden",!s),g(this.querySelectorAll(o.selectorItem),(e=>{e.toggleAttribute(o.attribItemHasIcon,s)}))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}updated(e){if(e.has("expanded")){const{selectorItem:e}=this.constructor,{expanded:t}=this;g(this.querySelectorAll(e),(e=>{e.tabIndex=t?0:-1}))}}render(){const{expanded:e,forceCollapsed:t,title:o,_handleClickExpando:n,_handleSlotChange:a,_handleSlotChangeTitleIcon:c}=this;return s`
      <button
        type="button"
        part="expando"
        aria-haspopup="true"
        aria-expanded="${String(Boolean(e&&!t))}"
        class="${r}--side-nav__submenu"
        @click=${n}>
        <div
          id="title-icon-container"
          part="title-icon-container"
        ...
        <span part="title" class="${r}--side-nav__submenu-title"
          >${o}</span
        >
        <div
          part="expando-icon-container"
          class="${r}--side-nav__icon ${r}--side-nav__icon--small ${r}--side-nav__submenu-chevron">
          ${(({children:e,...t}={})=>d`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${f(t)}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${e}<path d="M16 22L6 12 7.4 10.6 16 19.2 24.6 10.6 26 12z"></path></svg>`)({part:"expando-icon"})}
        </div>
      </button>
      <ul part="menu-body" class="${r}--side-nav__menu">
        <slot @slotchange=${a}></slot>
      </ul>
    `}static get selectorItem(){return`${r}-side-nav-menu-item`}static get eventBeforeToggle(){return`${r}-side-nav-menu-beingtoggled`}static get eventToggle(){return`${r}-side-nav-menu-toggled`}};F.attribItemHasIcon="parent-has-icon",F.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),F.styles=A,t([c("#title-icon-container")],F.prototype,"_titleIconContainerNode",void 0),t([a({type:Boolean,reflect:!0})],F.prototype,"active",void 0),t([a({type:Boolean,reflect:!0})],F.prototype,"expanded",void 0),t([a({type:Boolean,reflect:!0})],F.prototype,"large",void 0),t([a({type:Boolean,reflect:!0,attribute:"force-collapsed"})],F.prototype,"forceCollapsed",void 0),t([a()],F.prototype,"title",void 0),F=t([n(`${r}-side-nav-menu`)],F);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let X=class extends(m(o)){constructor(){super(...arguments),this.active=!1,this.href=""}shouldUpdate(e){if(e.has("active")&&this.active){const{selectorMenu:e}=this.constructor,t=this.closest(e);t&&(t.active=!0)}return!0}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","button"),super.connectedCallback()}render(){const{active:e,href:t,title:o}=this,d=u({[`${r}--side-nav__link`]:!0,[`${r}--side-nav__link--current`]:e});return s`
      <a part="link" class="${d}" href="${t}">
        <span part="title" class="${r}--side-nav__link-text">
          <slot>${o}</slot>
        </span>
      </a>
    `}static get selectorMenu(){return`${r}-side-nav-menu`}};X.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),X.styles=A,t([a({type:Boolean,reflect:!0})],X.prototype,"active",void 0),t([a()],X.prototype,"href",void 0),t([a()],X.prototype,"title",void 0),X=t([n(`${r}-side-nav-menu-item`)],X);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let q=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return s`<slot></slot>`}};q.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),q.styles=y,t([a({type:String,attribute:"aria-label"})],q.prototype,"ariaLabel",void 0),t([a({type:String,attribute:"aria-labelledby"})],q.prototype,"ariaLabelledBy",void 0),q=t([n(`${r}-switcher`)],q);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let D=class extends o{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","separator"),super.connectedCallback()}};D.styles=y,D=t([n(`${r}-switcher-divider`)],D);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let P=class extends(m(o)){constructor(){super(...arguments),this.href="",this.selected=!1,this.tabIndex=0}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{href:e,selected:t,ariaLabel:o,ariaLabelledBy:d,tabIndex:n}=this,a=u({[`${r}--switcher__item-link`]:!0,[`${r}--switcher__item-link--selected`]:t});return s`
      <a
        part="link"
        aria-label="${o}"
        aria-labelledby="${d}"
    ...
    `}};P.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),P.styles=y,t([a({type:String,attribute:"aria-label"})],P.prototype,"ariaLabel",void 0),t([a({type:String,attribute:"aria-labelledby"})],P.prototype,"ariaLabelledBy",void 0),t([a()],P.prototype,"href",void 0),t([a({type:Boolean,reflect:!0})],P.prototype,"selected",void 0),t([a({type:Number,reflect:!0,attribute:"tab-index"})],P.prototype,"tabIndex",void 0),P=t([n(`${r}-switcher-item`)],P);
