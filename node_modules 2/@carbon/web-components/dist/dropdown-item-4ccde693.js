...
import{i as e,x as t,p as s,s as i,_ as o,b as d}from"./settings-1096a273.js";import{n as c}from"./property-8bf17a69.js";import{s as r}from"./spread-c3902148.js";import{e as l}from"./class-map-f136ab55.js";import{o as a}from"./if-defined-7d77967b.js";import{r as n}from"./state-16f7c070.js";import{e as b}from"./query-602de8af.js";import{s as p}from"./16-66567a49.js";import{s as u}from"./16-d83d40a3.js";import{s as _}from"./16-635eac8f.js";import{F as g}from"./focus-a50a0482.js";import{F as x}from"./form-a750a2ac.js";import{H as m,a as h}from"./host-listener-69c546a1.js";import{V as v}from"./validity-45b7794a.js";import{f,i as w,b as y}from"./collection-helpers-8b117611.js";import"./shared-enums-562e6b51.js";import{c as k}from"./carbon-element-017b212d.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let B=class extends(v(m(x(g(i))))){constructor(){super(...arguments),this._hasAILabel=!1,this._selectedItemContent=null,this._shouldTriggerBeFocusable=!0,this.ariaLabel="",this.direction=q.BOTTOM,this.disabled=!1,this.helperText="",this.hideLabel=!1,this.invalid=!1,this.invalidText="",this.titleText="",this.name="",this.open=!1,this.readOnly=!1,this.required=!1,this.requiredValidityMessage="Please fill out this field.",this.size=I.MEDIUM,this.toggleLabelClosed="",this.toggleLabelOpen="",this.label="",this.type=$.DEFAULT,this.validityMessage="",this.value="",this.warn=!1,this.warnText=""}_selectionShouldChange(e){return!e||e.value!==this.value}_selectionDidChange(e){e&&(this.value=e.value,this._activeDescendant=e.id,f(this.querySelectorAll(this.constructor.selectorItemSelected),(e=>{e.selected=!1,e.setAttribute("aria-selected","false")})),e.selected=!0,e.setAttribute("aria-selected","true"),this._handleUserInitiatedToggle(!1))}_handleClickInner(e){if(!this.readOnly)if(this.shadowRoot.contains(e.target))this._handleUserInitiatedToggle();else{const t=e.target.closest(this.constructor.selectorItem);this.contains(t)&&this._handleUserInitiatedSelectItem(t)}}_handleKeydownInner(e){const{key:t}=e,s=this.constructor.getAction(t);if(this.open)switch(s){case S.CLOSING:this._handleUserInitiatedToggle(!1);break;case S.NAVIGATING:this._navigate(z[t])}else if(s===S.NAVIGATING)this._handleUserInitiatedToggle(!0),this._clearHighlight()}_handleKeypressInner(e){const{key:t}=e,s=this.constructor.getAction(t);if(this.open){if(s===S.TRIGGERING){const e=this.constructor,t=this.querySelector(e.selectorItemHighlighted);t?this._handleUserInitiatedSelectItem(t):this._handleUserInitiatedToggle(!1)}}else if(s===S.TRIGGERING)this._handleUserInitiatedToggle(!0)}_handleFocusOut(e){this.contains(e.relatedTarget)||this._handleUserInitiatedToggle(!1)}_handleSlotchangeHelperText(){this.requestUpdate()}_handleSlotchangeLabelText(){this.requestUpdate()}_handleAILabelSlotChange({target:e}){const t=e.assignedNodes().filter((e=>void 0!==e.matches&&(e.matches(this.constructor.aiLabelItem)||e.matches(this.constructor.slugItem))));this._hasAILabel=Boolean(t),t[0].setAttribute("size","mini"),this.requestUpdate()}_handleUserInitiatedSelectItem(e){if(!(null==e?void 0:e.hasAttribute("disabled"))&&this._selectionShouldChange(e)){const t={bubbles:!0,composed:!0,detail:{item:e}},s=this.constructor,i=new CustomEvent(s.eventBeforeSelect,Object.assign(Object.assign({},t),{cancelable:!0}));if(this.dispatchEvent(i)){this._selectionDidChange(e);const i=new CustomEvent(s.eventSelect,t);this.dispatchEvent(i)}}}_handleUserInitiatedToggle(e=!this.open){const{eventBeforeToggle:t,eventToggle:s}=this.constructor,{disabled:i}=this,o={bubbles:!0,cancelable:!0,composed:!0,detail:{open:e}};i||this.dispatchEvent(new CustomEvent(t,o))&&(this.open=e,this.open||f(this.querySelectorAll(this.constructor.selectorItemHighlighted),(e=>{e.highlighted=!1})),this.requestUpdate(),this.dispatchEvent(new CustomEvent(s,o)))}_clearHighlight(){f(this.querySelectorAll(this.constructor.selectorItem),(e=>{e.highlighted=!1}))}_navigate(e){var t;const s=this.constructor,i=this.querySelectorAll(s.selectorItem),o=this.querySelector(s.selectorItemHighlighted);let d=w(i,o)+e;(null===(t=i[d])||void 0===t?void 0:t.hasAttribute("disabled"))&&(d+=e),d<0&&(d=i.length-1),d>=i.length&&(d=0),f(i,((e,t)=>{e.highlighted=t===d}));const c=i[d];c.scrollIntoView({block:"nearest"});const r=c.id;r&&(this._activeDescendant=r)}_renderPrecedingLabel(){}_renderLabel(){const{label:e,_selectedItemContent:i}=this;return t`
      <span id="trigger-label" class="${s}--list-box__label"
        >${i||e}</span
      >
    `}_renderTitleLabel(){const{disabled:e,hideLabel:i,titleText:o,_slotTitleTextNode:d,_handleSlotchangeLabelText:c}=this,r=l({[`${s}--label`]:!0,[`${s}--label--disabled`]:e,[`${s}--visually-hidden`]:i}),a=o||d&&d.assignedNodes().length>0;return t`
      <label
        id="dropdown-label"
        part="title-text"
        class="${r}"
        for="trigger-button"
        ?hidden="${!a}">
        <slot name="title-text" @slotchange="${c}"
          >${o}</slot
        >
      </label>
    `}_renderFollowingLabel(){}_handleFormdata(e){const{formData:t}=e,{disabled:s,name:i,value:o}=this;s||t.append(i,o)}shouldUpdate(e){const{selectorItem:t}=this.constructor;if(e.has("size")&&f(this.querySelectorAll(t),(e=>{e.size=this.size})),e.has("disabled")&&this.disabled){const{disabled:e}=this;f(this.querySelectorAll(t),(t=>{e?t.disabled=e:t.removeAttribute("disabled")}))}if(e.has("value")){f(this.querySelectorAll(t),(e=>{e.selected=e.value===this.value}));const e=y(this.querySelectorAll(t),(e=>e.value===this.value));if(e){const t=this.ownerDocument.createRange();t.selectNodeContents(e),this._selectedItemContent=t.cloneContents()}else this._selectedItemContent=null}return!0}updated(e){var t,i,o,d,c;this._hasAILabel?this.setAttribute("ai-label",""):this.removeAttribute("ai-label");const r=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("slot[name='ai-label']");r?null==r||r.classList.toggle(`${s}--slug--revert`,null===(i=this.querySelector(`${s}-ai-label`))||void 0===i?void 0:i.hasAttribute("revert-active")):null===(d=null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector("slot[name='slug']"))||void 0===d||d.classList.toggle(`${s}--slug--revert`,null===(c=this.querySelector(`${s}-slug`))||void 0===c?void 0:c.hasAttribute("revert-active"))}get _classes(){const{disabled:e,size:t,type:i,invalid:o,open:d,warn:c}=this,r=i===$.INLINE,a=this.querySelectorAll(this.constructor.selectorItemSelected).length;return l({[`${s}--dropdown`]:!0,[`${s}--list-box`]:!0,[`${s}--list-box--disabled`]:e,[`${s}--list-box--inline`]:r,[`${s}--list-box--expanded`]:d,[`${s}--list-box--${t}`]:t,[`${s}--dropdown--invalid`]:o,[`${s}--dropdown--warn`]:c,[`${s}--dropdown--inline`]:r,[`${s}--dropdown--selected`]:a>0})}render(){var e;const{ariaLabel:i,_classes:o,disabled:d,helperText:c,invalid:r,invalidText:n,open:b,toggleLabelClosed:g,toggleLabelOpen:x,type:m,warn:h,warnText:v,_activeDescendant:f,_shouldTriggerBeFocusable:w,_handleClickInner:y,_handleKeydownInner:k,_handleKeypressInner:z,_handleSlotchangeHelperText:S,_handleAILabelSlotChange:I,_slotHelperTextNode:q}=this,T=m===$.INLINE;let B;if(b&&!f){const t=this.constructor;B=null===(e=this.querySelectorAll(t.selectorItem)[0])||void 0===e?void 0:e.id}const L=l({[`${s}--form__helper-text`]:!0,[`${s}--form__helper-text--disabled`]:d}),A=l({[`${s}--list-box__menu-icon`]:!0,[`${s}--list-box__menu-icon--open`]:b}),M=(b?x:g)||void 0,N=c||n||v||q&&q.assignedNodes().length>0,F=r?u({class:`${s}--list-box__invalid-icon`,"aria-label":M}):void 0,C=!h||r&&h?void 0:_({class:`${s}--list-box__invalid-icon ${s}--list-box__invalid-icon--warning`,"aria-label":M}),j=r?n:h?v:c,R=t`
      <div
        aria-labelledby="${a(i?void 0:"dropdown-label")}"
        aria-label="${a(i||void 0)}"
        id="menu-body"
        part="menu-body"
        class="${s}--list-box__menu"
        role="listbox"
        tabindex="-1"
        ?hidden=${!b}>
        <slot></slot>
    ...
    `;return t`
      ...
      <div
        ...
        @keypress=${z}>
        <div
          id="${a(w?"trigger-button":void 0)}"
          class="${s}--list-box__field"
          part="trigger-button"
          tabindex="${a(w?"0":void 0)}"
          role="${a(w?"combobox":void 0)}"
          aria-labelledby="${a(w?"dropdown-label":void 0)}"
          aria-expanded="${a(w?String(b):void 0)}"
          aria-haspopup="${a(w?"listbox":void 0)}"
          aria-controls="${a(w?"menu-body":void 0)}"
          aria-activedescendant="${a(w?b?null!=f?f:B:"":void 0)}">
          ${this._renderPrecedingLabel()}${this._renderLabel()}${F}${C}${this._renderFollowingLabel()}
          <div id="trigger-caret" class="${A}">
            ${p({"aria-label":M})}
          </div>
        </div>
        <slot name="ai-label" @slotchange=${I}></slot>
        <slot name="slug" @slotchange=${I}></slot>
        ${R}
      </div>
      <div
        part="helper-text"
    ...
    `}static get selectorItemHighlighted(){return`${s}-dropdown-item[highlighted]`}static get selectorItem(){return`${s}-dropdown-item`}static get selectorItemSelected(){return`${s}-dropdown-item[selected]`}static get eventBeforeSelect(){return`${s}-dropdown-beingselected`}static get eventSelect(){return`${s}-dropdown-selected`}static get eventBeforeToggle(){return`${s}-dropdown-beingtoggled`}static get eventToggle(){return`${s}-dropdown-toggled`}static get slugItem(){return`${s}-slug`}static get aiLabelItem(){return`${s}-ai-label`}static getAction(e){return"Escape"===e?S.CLOSING:e in z?S.NAVIGATING:this.TRIGGER_KEYS.has(e)?S.TRIGGERING:S.NONE}};B.TRIGGER_KEYS=new Set([" ","Enter"]),B.shadowRootOptions=Object.assign(Object.assign({},i.shadowRootOptions),{delegatesFocus:!0}),B.styles=T,o([n()],B.prototype,"_activeDescendant",void 0),o([b(`.${s}--list-box`)],B.prototype,"_listBoxNode",void 0),o([b('slot[name="helper-text"]')],B.prototype,"_slotHelperTextNode",void 0),o([b('slot[name="title-text"]')],B.prototype,"_slotTitleTextNode",void 0),o([h("focusout")],B.prototype,"_handleFocusOut",null),o([c({type:String,reflect:!0,attribute:"aria-label"})],B.prototype,"ariaLabel",void 0),o([c({type:String,reflect:!0})],B.prototype,"direction",void 0),o([c({type:Boolean,reflect:!0})],B.prototype,"disabled",void 0),o([c({attribute:"helper-text"})],B.prototype,"helperText",void 0),o([c({type:Boolean,reflect:!0,attribute:"hide-label"})],B.prototype,"hideLabel",void 0),o([c({type:Boolean,reflect:!0})],B.prototype,"invalid",void 0),o([c({attribute:"invalid-text"})],B.prototype,"invalidText",void 0),o([c({attribute:"title-text"})],B.prototype,"titleText",void 0),o([c()],B.prototype,"name",void 0),o([c({type:Boolean,reflect:!0})],B.prototype,"open",void 0),o([c({type:Boolean,reflect:!0,attribute:"read-only"})],B.prototype,"readOnly",void 0),o([c({type:Boolean,reflect:!0})],B.prototype,"required",void 0),o([c({attribute:"required-validity-message"})],B.prototype,"requiredValidityMessage",void 0),o([c({reflect:!0})],B.prototype,"size",void 0),o([c({attribute:"toggle-label-closed"})],B.prototype,"toggleLabelClosed",void 0),o([c({attribute:"toggle-label-open"})],B.prototype,"toggleLabelOpen",void 0),o([c({attribute:"label"})],B.prototype,"label",void 0),o([c({reflect:!0})],B.prototype,"type",void 0),o([c({attribute:"validity-message"})],B.prototype,"validityMessage",void 0),o([c({reflect:!0})],B.prototype,"value",void 0),o([c({type:Boolean,reflect:!0})],B.prototype,"warn",void 0),o([c({attribute:"warn-text"})],B.prototype,"warnText",void 0),B=o([k(`${s}-dropdown`)],B);var L=B;
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let A=class extends i{constructor(){super(...arguments),this.disabled=!1,this.highlighted=!1,this.selected=!1,this.size=I.MEDIUM,this.value=""}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","option"),this.hasAttribute("id")||this.setAttribute("id",`${s}-dropdown-item-${this.constructor.id++}`),this.setAttribute("aria-selected",String(this.selected))}render(){const{selected:e}=this;return t`
      <div class="${s}--list-box__menu-item__option">
        <slot></slot>
        ${e?(({children:e,...t}={})=>d`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${r(t)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${e}<path d="M13 24L4 15 5.414 13.586 13 21.171 26.586 7.586 28 9 13 24z"></path></svg>`)({part:"selected-icon",class:`${s}--list-box__menu-item__selected-icon`}):void 0}
      </div>
    `}};A.id=0,A.styles=T,o([c({type:Boolean,reflect:!0})],A.prototype,"disabled",void 0),o([c({type:Boolean,reflect:!0})],A.prototype,"highlighted",void 0),o([c({type:Boolean,reflect:!0})],A.prototype,"selected",void 0),o([c({reflect:!0})],A.prototype,"size",void 0),o([c()],A.prototype,"value",void 0),A=o([k(`${s}-dropdown-item`)],A);var M=A;export{L as C,S as D,M as a,$ as b,T as s};
