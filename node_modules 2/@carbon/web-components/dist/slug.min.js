 ...
 * LICENSE file in the root directory of this source tree.
 */
let g=class extends r{constructor(){super(...arguments),this.slot="slug",this.aiText="AI",this.aiTextLabel="",this.kind=l.DEFAULT,this.revertActive=!1,this.revertLabel="Revert to AI input",this.size=i.EXTRA_SMALL,this.slugLabel="Show information",this._handleClick=()=>{this.revertActive?(this.revertActive=!1,this.removeAttribute("revert-active")):this.open=!this.open},this._renderToggleTipLabel=()=>e``,this._renderTooltipButton=()=>{const{size:o,kind:t,aiText:c,aiTextLabel:r,slugLabel:d}=this,n=`${c} - ${d}`,a=p({[`${s}--toggletip-button`]:!0,[`${s}--slug__button`]:!0,[`${s}--slug__button--${o}`]:o,[`${s}--slug__button--${t}`]:t,[`${s}--slug__button--inline-with-content`]:t===l.INLINE&&r});return e`
      <button
    ...
    `},this._renderInnerContent=()=>{const{autoalign:o,revertActive:t,revertLabel:s}=this;return e`
      ${t?e`
          ...
          `}
    `}}attributeChangedCallback(o,t,e){var s;super.attributeChangedCallback(o,t,e),"revert-active"===o&&(null===(s=this.parentElement)||void 0===s||s.requestUpdate())}};g.styles=v,t([c({reflect:!0})],g.prototype,"slot",void 0),t([c({attribute:"ai-text"})],g.prototype,"aiText",void 0),t([c({attribute:"ai-text-label"})],g.prototype,"aiTextLabel",void 0),t([c({reflect:!0})],g.prototype,"kind",void 0),t([c({type:Boolean,attribute:"revert-active"})],g.prototype,"revertActive",void 0),t([c({attribute:"revert-label"})],g.prototype,"revertLabel",void 0),t([c({reflect:!0})],g.prototype,"size",void 0),t([c({attribute:"slug-label"})],g.prototype,"slugLabel",void 0),t([c()],g.prototype,"previousValue",void 0),g=t([n(`${s}-slug`)],g);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let h=class extends a{constructor(){super(...arguments),this.slot="actions"}};h.styles=v,t([c({reflect:!0})],h.prototype,"slot",void 0),h=t([n(`${s}-slug-action-button`)],h);
