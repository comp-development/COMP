 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=v=class extends p{constructor(){super(...arguments),this.popoverController=new a(this),this.align="",this.autoalign=!1,this.caret=!0,this.dropShadow=!0,this.highContrast=!1,this.open=!1,this.tabTip=!1}_handleSlotChange({target:o}){if(this.tabTip){o.assignedNodes().filter((o=>o.nodeType!==Node.TEXT_NODE||o.textContent.trim()))[0].classList.add(`${e}--popover--tab-tip__button`)}this.requestUpdate()}updated(o){var t,p,e;const{selectorPopoverContent:s}=this.constructor;if(["open","align","autoalign","caret","dropShadow","tabTip"].forEach((t=>{if(o.has(t)){const{[t]:o}=this;this.querySelector(s)&&(this.querySelector(s)[t]=o)}})),this.autoalign&&this.open){const o=this._triggerSlotNode.assignedElements()[0],s=this._contentSlotNode.assignedElements()[0],c=null===(t=null==s?void 0:s.shadowRoot)||void 0===t?void 0:t.querySelector(v.selectorPopoverContentClass),r=null===(p=null==s?void 0:s.shadowRoot)||void 0===p?void 0:p.querySelector(v.selectorPopoverCaret);o&&c&&(null===(e=this.popoverController)||void 0===e||e.setPlacement({trigger:o,target:c,arrowElement:this.caret&&r?r:void 0,caret:this.caret,flip:!0,alignment:this.align}))}}render(){const{dropShadow:o,highContrast:t,open:p,tabTip:r,_handleSlotChange:n}=this;r&&(this.caret=!r),this.align=this.align?this.align:r?"bottom-left":"bottom";const d=c({[`${e}--popover-container`]:!0,[`${e}--popover--caret`]:this.caret,[`${e}--popover--drop-shadow`]:o,[`${e}--popover--high-contrast`]:t,[`${e}--popover--open`]:p,[`${e}--popover--${this.align}`]:!0,[`${e}--popover--tab-tip`]:r});return s`
    <span class="${d}">
      <slot @slotchange="${n}"></slot>
      <slot name="content"><slot>
    </span>
    `}static get selectorPopoverContentClass(){return`.${e}--popover-content`}static get selectorPopoverCaret(){return`.${e}--popover-caret`}static get selectorPopoverContent(){return`${e}-popover-content`}};l.styles=i,t([n("slot")],l.prototype,"_triggerSlotNode",void 0),t([n('slot[name="content"]')],l.prototype,"_contentSlotNode",void 0),t([r({reflect:!0,type:String})],l.prototype,"align",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"autoalign",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"caret",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"dropShadow",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"highContrast",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"open",void 0),t([r({type:Boolean,reflect:!0})],l.prototype,"tabTip",void 0),l=v=t([d(`${e}-popover`)],l);var h=l;
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let g=class extends p{constructor(){super(...arguments),this.align="",this.autoalign=!1,this.dropShadow=!0,this.open=!1,this.tabTip=!1,this.slot="content"}render(){return this.autoalign?s`
        <span class="${e}--popover-content">
          <slot> </slot>
      ...
      `:s`
        ...
        <span class="${e}--popover-caret"></span>
      `}};g.styles=i,t([r({reflect:!0,type:String})],g.prototype,"align",void 0),t([r({type:Boolean,reflect:!0})],g.prototype,"autoalign",void 0),t([r({type:Boolean,reflect:!0})],g.prototype,"caret",void 0),t([r({type:Boolean,reflect:!0})],g.prototype,"dropShadow",void 0),t([r({type:Boolean,reflect:!0})],g.prototype,"open",void 0),t([r({type:Boolean,reflect:!0})],g.prototype,"tabTip",void 0),t([r({reflect:!0})],g.prototype,"slot",void 0),g=t([d(`${e}-popover-content`)],g);var u=g;export{h as C,u as a};
