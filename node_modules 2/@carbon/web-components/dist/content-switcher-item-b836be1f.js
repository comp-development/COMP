...
import{i as e,_ as t,s as o,p as c,x as s}from"./settings-1096a273.js";import{n as r}from"./property-8bf17a69.js";import{i as n,f as d}from"./collection-helpers-8b117611.js";import{c as i}from"./carbon-element-017b212d.js";import{e as a}from"./class-map-f136ab55.js";import{o as p}from"./if-defined-7d77967b.js";import{F as l}from"./focus-a50a0482.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let g=class extends o{constructor(){super(...arguments),this.value="",this.size=b.REGULAR,this.iconOnly=!1}_handleHover({target:e,type:t}){const{selectorItem:o}=this.constructor,c=this.querySelectorAll(o),s="mouseover"!==t?-1:n(c,e.closest(o)),r=s<0?s:s+1;d(this.querySelectorAll(o),((e,t)=>{e.hideDivider=t===r}));const{selectorItemSelected:i}=this.constructor,a=this.querySelector(i);this._getNextItem(a,1).hideDivider=!0}_getCurrentItem(e){var t;const o=this.querySelectorAll(this.constructor.selectorItemEnabled),{selectorItem:c}=this.constructor,s=e.closest(c);return null!==(t=o[n(o,s)])&&void 0!==t?t:null}_getNextItem(e,t){const o=this.querySelectorAll(this.constructor.selectorItemEnabled),c=n(o,e),s=(r=c+t,d=o.length,r<0?d-1:r>=d?0:r);var r,d;return s===c?null:o[s]}_handleClick({target:e}){const t=this._getCurrentItem(e);this._handleUserInitiatedSelectItem(t)}_handleKeydown({key:e}){e in v&&this._navigate(v[e])}_handleUserInitiatedSelectItem(e){if(!e.disabled&&e.value!==this.value){const t={bubbles:!0,composed:!0,detail:{item:e}},o=this.constructor,c=new CustomEvent(o.eventBeforeSelect,Object.assign(Object.assign({},t),{cancelable:!0}));if(this.dispatchEvent(c)){this._selectionDidChange(e);const c=new CustomEvent(o.eventSelect,t);this.dispatchEvent(c)}}}_navigate(e){const{selectorItemSelected:t}=this.constructor,o=this._getNextItem(this.querySelector(t),e);o&&(this._handleUserInitiatedSelectItem(o),this.requestUpdate())}_selectionDidChange(e){this.value=e.value,d(this.querySelectorAll(this.constructor.selectorItemSelected),(e=>{e.selected=!1})),e.selected=!0,Promise.resolve().then((()=>{e.focus();const{selectorItem:t}=this.constructor,o=this.querySelectorAll(t),c=n(o,e.closest(t)),s=c<0?c:c+1;d(this.querySelectorAll(t),((e,t)=>{e.hideDivider=t===s}))}))}shouldUpdate(e){if(e.has("value")){const{selectorItem:e}=this.constructor;d(this.querySelectorAll(e),(e=>{e.selected=e.value===this.value}))}const{selectorIconItem:t}=this.constructor;return this.querySelector(t)&&(this.iconOnly=!0),!0}_handleSlotchange(){const{selectorItemSelected:e}=this.constructor,t=this.querySelector(e);this._getNextItem(t,1).hideDivider=!0}static get selectorItem(){return`${c}-content-switcher-item`}static get selectorIconItem(){return`${c}-content-switcher-item[icon]`}static get selectorItemEnabled(){return`${c}-content-switcher-item:not([disabled])`}static get selectorItemSelected(){return`${c}-content-switcher-item[selected]`}static get eventBeforeSelect(){return`${c}-content-switcher-beingselected`}static get eventSelect(){return`${c}-content-switcher-selected`}render(){const{_handleHover:e,_handleKeydown:t,_handleSlotchange:o}=this;return s`
      <slot
        ...
        @mouseout="${e}"
        @slotchange=${o}></slot>
    `}};g.styles=h,t([r({reflect:!0})],g.prototype,"value",void 0),t([r({reflect:!0})],g.prototype,"size",void 0),t([r({type:Boolean,reflect:!0,attribute:"icon"})],g.prototype,"iconOnly",void 0),g=t([i(`${c}-content-switcher`)],g);var u=g;
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let f=class extends(l(o)){constructor(){super(...arguments),this.disabled=!1,this.hideDivider=!1,this.selected=!1,this.value="",this.icon=!1,this.align="top",this.closeOnActivation=!0,this.enterDelayMs=100,this.leaveDelayMs=100}updated(e){var t,o,s,r;e&&(null===(r=null===(s=null===(o=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(`${c}-tooltip`))||void 0===o?void 0:o.shadowRoot)||void 0===s?void 0:s.querySelector(`.${c}--tooltip`))||void 0===r||r.classList.add(`${c}--icon-tooltip`))}_renderTooltipContent(){return s`
      <cds-tooltip-content>
        <slot name="tooltip-content"></slot>
      </cds-tooltip-content>
    `}shouldUpdate(e){if(e.has("selected")||e.has("target")){const{selected:e,target:t}=this;if(t){const o=this.getRootNode(),c=null==o?void 0:o.getElementById(t);null==c||c.toggleAttribute("hidden",!e)}}return!0}render(){const{disabled:e,selected:t,target:o}=this,r=a({[`${c}--content-switcher-btn`]:!0,[`${c}--content-switcher--selected`]:t}),n=s`<button
      type="button"
      role="tab"
      class="${r}"
      ?disabled="${e}"
      tabindex="${t?"0":"-1"}"
      aria-controls="${p(o)}"
      aria-selected="${Boolean(t)}">
      <span class="${c}--content-switcher__label"><slot></slot></span>
    </button>`;if(this.icon){const{align:e,closeOnActivation:t,enterDelayMs:o,leaveDelayMs:c}=this;return s`<cds-tooltip
        align=${e}
        close-on-activation="${t}"
        enter-delay-ms=${o}
        leave-delay-ms=${c}>
        ${n} ${this._renderTooltipContent()}
      </cds-tooltip>`}return n}};f.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),f.styles=h,t([r({type:Boolean,reflect:!0})],f.prototype,"disabled",void 0),t([r({type:Boolean,reflect:!0,attribute:"hide-divider"})],f.prototype,"hideDivider",void 0),t([r({type:Boolean,reflect:!0})],f.prototype,"selected",void 0),t([r()],f.prototype,"target",void 0),t([r()],f.prototype,"value",void 0),t([r({type:Boolean,reflect:!0})],f.prototype,"icon",void 0),t([r({reflect:!0,type:String})],f.prototype,"align",void 0),t([r({attribute:"close-on-activation",reflect:!0,type:Boolean})],f.prototype,"closeOnActivation",void 0),f=t([i(`${c}-content-switcher-item`)],f);var y=f;export{u as C,v as N,y as a};
