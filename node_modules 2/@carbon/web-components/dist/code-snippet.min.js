...
import{w as e,i as o,s as t,_ as s,p as n,x as c}from"./settings-1096a273.js";import{e as d,i,t as r}from"./directive-e2d48b9c.js";import{n as p}from"./property-8bf17a69.js";import{s as a}from"./16-66567a49.js";import{F as l}from"./focus-a50a0482.js";import"./shared-enums-562e6b51.js";import"./copy-button-019b4375.js";import"./button-7c58436e.js";import{c as v}from"./carbon-element-017b212d.js";import"./spread-c3902148.js";import"./icon-button-3c7e5c61.js";import"./tooltip-content-8c7333b6.js";import"./host-listener-69c546a1.js";import"./on-8707857f.js";import"./popover-content-f8458b22.js";import"./class-map-f136ab55.js";import"./query-602de8af.js";import"./popover-controller-c3634b83.js";import"./button-set-9c90b997.js";import"./button-skeleton-c4243201.js";import"./if-defined-7d77967b.js";
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const b="important",h=" !"+b,g=d(class extends i{constructor(e){if(super(e),e.type!==r.ATTRIBUTE||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((o,t)=>{const s=e[t];return null==s?o:o+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(o,[t]){const{style:s}=o.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(t)),this.render(t);for(const e of this.ft)null==t[e]&&(this.ft.delete(e),e.includes("-")?s.removeProperty(e):s[e]=null);for(const e in t){const o=t[e];if(null!=o){this.ft.add(e);const t="string"==typeof o&&o.endsWith(h);e.includes("-")||t?s.setProperty(e,t?o.slice(0,-11):o,t?b:""):s[e]=o}}return e}});
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let m=class extends(l(t)){constructor(){super(...arguments),this._expandedCode=!1,this._hObserveResize=null,this._rowHeightInPixels=16,this._hasRightOverflow=!0,this._hasLeftOverflow=!1,this._shouldShowMoreLessBtn=!1,this._resizeObserver=new ResizeObserver((()=>{var e;const o=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(`.${n}--snippet-container`),t=null==o?void 0:o.querySelector("code"),{type:s,maxCollapsedNumberOfRows:c,maxExpandedNumberOfRows:d,minExpandedNumberOfRows:i,_rowHeightInPixels:r,_handleScroll:p}=this;if(t&&s===f.MULTI){const{height:e}=t.getBoundingClientRect();this._shouldShowMoreLessBtn=c>0&&(d<=0||d>c)&&e>c*r,this._expandedCode&&i>0&&e<=i*r&&(this._expandedCode=!1)}(t&&s===f.MULTI||o&&s===f.SINGLE)&&p(),this.requestUpdate()})),this.copyText="",this.disabled=!1,this.feedback="Copied!",this.feedbackTimeout=2e3,this.hideCopyButton=!1,this.maxCollapsedNumberOfRows=15,this.maxExpandedNumberOfRows=0,this.minCollapsedNumberOfRows=3,this.minExpandedNumberOfRows=16,this.showLessText="Show less",this.showMoreText="Show more",this.tooltipContent="Copy to clipboard",this.wrapText=!1,this.type=f.SINGLE}_handleCopyClick(){const{ownerDocument:e}=this,o=e.defaultView.getSelection();o.removeAllRanges();const t=e.createElement("code");t.className=`${n}--visually-hidden`;const s=e.createElement("pre"),c=Array.from(this.childNodes).filter((e=>e.nodeType===Node.TEXT_NODE));s.textContent=this.copyText||c[0].textContent,t.appendChild(s),e.body.appendChild(t);const d=e.createRange();d.selectNodeContents(t),o.addRange(d),e.execCommand("copy"),e.body.removeChild(t),o.removeAllRanges()}_getCodeRefDimensions(e){const{clientWidth:o,scrollLeft:t,scrollWidth:s}=e;return{horizontalOverflow:s>o,codeClientWidth:o,codeScrollWidth:s,codeScrollLeft:t}}_handleScroll(){var e;if(this){const o=null===(e=null==this?void 0:this.shadowRoot)||void 0===e?void 0:e.querySelector(`.${n}--snippet-container`),t=null==o?void 0:o.querySelector("pre");if(this.type===f.INLINE||this.type===f.SINGLE&&!o||this.type===f.MULTI&&!t)return;const{horizontalOverflow:s,codeClientWidth:c,codeScrollWidth:d,codeScrollLeft:i}=this.type===f.SINGLE?this._getCodeRefDimensions(o):this._getCodeRefDimensions(t);this._hasLeftOverflow=s&&!!i,this._hasRightOverflow=s&&i+c!==d,this.requestUpdate()}}_handleClickExpanded(){this._expandedCode=!this._expandedCode,this.requestUpdate()}connectedCallback(){var e,o;super.connectedCallback(),this._hObserveResize&&(this._hObserveResize=this._hObserveResize.release()),this._hObserveResize=(e=this._resizeObserver,(o=this)?(e.observe(o),{release:()=>(e.unobserve(o),null)}):null)}disconnectedCallback(){this._hObserveResize&&(this._hObserveResize=this._hObserveResize.release())}updated(){this._expandedCode?this.setAttribute("expanded-code",""):this.removeAttribute("expanded-code")}render(){const{disabled:e,feedback:o,feedbackTimeout:t,hideCopyButton:s,maxExpandedNumberOfRows:d,minExpandedNumberOfRows:i,maxCollapsedNumberOfRows:r,minCollapsedNumberOfRows:p,type:l,wrapText:v,tooltipContent:b,showMoreText:h,showLessText:u,_expandedCode:m,_handleCopyClick:y,_handleScroll:x,_hasRightOverflow:k,_hasLeftOverflow:z,_rowHeightInPixels:_,_shouldShowMoreLessBtn:w}=this;let S=`${n}--snippet`;l&&(S+=` ${n}--snippet--${l}`),"inline"!==l&&e&&(S+=` ${n}--snippet--disabled`),s&&(S+=` ${n}--snippet--no-copy`),v&&(S+=` ${n}--snippet--wraptext`),"multi"==l&&k&&(S+=` ${n}--snippet--has-right-overflow`);const M=`${n}--snippet-btn--expand`,R=e?`${n}--snippet--disabled`:"",C=m?u:h;if(l===f.INLINE)return c`
        <cds-copy button-class-name="${S}" @click="${y}">
          <code slot="icon"><slot></slot></code>
          <span slot="tooltip-content">${b}</span>
        </cds-copy>
      `;const N={};return"multi"===l&&(m?(d>0&&(N["max-height"]=d*_+"px"),i>0&&(N["min-height"]=i*_+"px")):(r>0&&(N["max-height"]=r*_+"px"),p>0&&(N["min-height"]=p*_+"px"))),c`
      <div
 ...
 * LICENSE file in the root directory of this source tree.
 */
let y=class extends t{constructor(){super(...arguments),this.type=f.SINGLE}render(){return c`
