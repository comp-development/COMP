...
import{i as e,_ as o,s as t,p as n,x as s}from"./settings-1096a273.js";import{e as i}from"./class-map-f136ab55.js";import{n as r}from"./property-8bf17a69.js";import{c as a}from"./carbon-element-017b212d.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */function d(e,o,t){return Math.floor([.973051493507435,.15334737213558558,.5671034553053769][t%3]*(o-e+1))+e}let f=class extends t{constructor(){super(...arguments),this.type=l.REGULAR,this.width="100%",this.paragraph=!1,this.lineCount=3}render(){const{optionalClasses:e,paragraph:o,lineCount:t,type:r,width:a}=this;let c={[`${n}--skeleton__text`]:!0,[`${n}--skeleton__heading`]:r===l.HEADING};if(e){const o={};null==e||e.split(" ").forEach((e=>{o[e]=!0})),c=Object.assign(Object.assign({},c),o)}const f=i(c);if(o){const e=parseInt(this.width,10),o=this.width.includes("px"),n=this.width.includes("%"),i=[];for(let r=0;r<t;r++){const t=n&&`${d(0,75,r)}px`||o&&`${d(0,e,r)}px`,l=n&&`width: calc(${a} - ${t})`||o&&`width: ${t}`||"";i.push(s`<p class="${f}" style="${l}"></p>`)}return i}return s`<p class="${f}" style="width:${a}"></p>`}};f.styles=c,o([r({reflect:!0,attribute:"optional-classes"})],f.prototype,"optionalClasses",void 0),o([r({reflect:!0})],f.prototype,"type",void 0),o([r({reflect:!0})],f.prototype,"width",void 0),o([r({type:Boolean,reflect:!0})],f.prototype,"paragraph",void 0),o([r({type:Number,reflect:!0})],f.prototype,"lineCount",void 0),f=o([a(`${n}-skeleton-text`)],f);export{l as S};
