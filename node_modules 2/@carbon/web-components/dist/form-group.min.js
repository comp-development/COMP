 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=class extends r{constructor(){super(...arguments),this.invalid=!1,this.message=!1}render(){const{invalid:e,legendId:t,legendText:r,message:a,messageText:d}=this;return i`
      <fieldset
        class="${s}--fieldset"
        ?data-invalid=${e}
        aria-labelledby="${t}">
        <legend class="${s}--label" id=${t}>${r}</legend>
        <slot></slot>
        ${a?i`<div class="${s}--form__requirements">
              ${d}
            </div>`:null}
      </fieldset>
    `}};l.styles=c,t([a({type:Boolean,reflect:!0})],l.prototype,"invalid",void 0),t([a({attribute:"legend-id"})],l.prototype,"legendId",void 0),t([a({attribute:"legend-text"})],l.prototype,"legendText",void 0),t([a({type:Boolean,reflect:!0})],l.prototype,"message",void 0),t([a({type:String,attribute:"message-text",reflect:!0})],l.prototype,"messageText",void 0),l=t([d(`${s}-form-group`)],l);
