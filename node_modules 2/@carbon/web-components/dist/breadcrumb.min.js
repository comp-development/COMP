 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=class extends t{constructor(){super(...arguments),this.noTrailingSlash=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}render(){const o=c({[`${r}--breadcrumb`]:!0,[`${r}--breadcrumb--no-trailing-slash`]:this.noTrailingSlash});return s`
      <ol class="${o}">
        <slot></slot>
      </ol>
    `}};l.styles=a,e([n({type:Boolean,reflect:!0,attribute:"no-trailing-slash"})],l.prototype,"noTrailingSlash",void 0),l=e([d(`${r}-breadcrumb`)],l);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let p=class extends t{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){return s` <slot></slot> `}};p.styles=a,p=e([d(`${r}-breadcrumb-item`)],p);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends i{render(){return s`
      ${this.href?super.render():s`<span class="${r}--link"><slot></slot></span>`}
    `}};v.styles=a,v=e([d(`${r}-breadcrumb-link`)],v);
/**
 * @license
 *
 ...
 */
const b=()=>s`
    <div class="${r}--breadcrumb-item">
      <span class="${r}--link">&nbsp;</span>
    </div>
  `;let m=class extends t{render(){return s`
      <div class="${r}--breadcrumb ${r}--skeleton">
        ${b()} ${b()} ${b()}
      </div>
    `}};m.styles=a,m=e([d(`${r}-breadcrumb-skeleton`)],m);
