...
import{i as o,p as e,x as t,a as s,_ as r,s as d}from"./settings-1096a273.js";import{e as c}from"./class-map-f136ab55.js";import{n as a}from"./property-8bf17a69.js";import{e as n}from"./query-602de8af.js";import{H as i,a as l}from"./host-listener-69c546a1.js";import{c as p}from"./carbon-element-017b212d.js";import{s as v}from"./20-fd76427e.js";import{o as b}from"./if-defined-7d77967b.js";import{F as m}from"./focus-a50a0482.js";import{b as h,C as u}from"./button-7c58436e.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const y=Node.DOCUMENT_POSITION_PRECEDING|Node.DOCUMENT_POSITION_CONTAINS,x=Node.DOCUMENT_POSITION_FOLLOWING|Node.DOCUMENT_POSITION_CONTAINED_BY;function _(o,e=!1){if(e)for(let e=o.length-1;e>=0;--e){const t=o[e];if(t.focus(),t.ownerDocument.activeElement===t)return!0}else for(let e=0;e<o.length;++e){const t=o[e];if(t.focus(),t.ownerDocument.activeElement===t)return!0}return!1}let z=class extends(i(d)){constructor(){super(...arguments),this._launcher=null,this._handleClick=o=>{o.composedPath().indexOf(this.shadowRoot)<0&&!this.preventCloseOnClickOutside&&this._handleUserInitiatedClose(o.target)},this._handleBlur=async({target:o,relatedTarget:e})=>{var t;const{open:s,_startSentinelNode:r,_endSentinelNode:d}=this,c=o!==this&&this.contains(o),a=e!==this&&(this.contains(e)||(null===(t=this.shadowRoot)||void 0===t?void 0:t.contains(e))&&e!==d),{selectorTabbable:n}=this.constructor;if(s&&e&&c&&!a){const t=o.compareDocumentPosition(e);e===r||t&y?(await this.constructor._delay(),_(this.querySelectorAll(n),!0)||e===this||this.focus()):(e===d||t&x)&&(await this.constructor._delay(),_(this.querySelectorAll(n))||this.focus())}},this._handleKeydown=({key:o,target:e})=>{"Esc"!==o&&"Escape"!==o||this._handleUserInitiatedClose(e)},this.alert=!1,this.ariaLabel="",this.containerClass="",this.fullWidth=!1,this.hasScrollingContent=!1,this.open=!1,this.size=g.MEDIUM,this.preventCloseOnClickOutside=!1,this.preventClose=!1}_handleClickContainer(o){o.target.matches(this.constructor.selectorCloseButton)&&!this.preventClose&&this._handleUserInitiatedClose(o.target)}_handleUserInitiatedClose(o){if(this.open){const e={bubbles:!0,cancelable:!0,composed:!0,detail:{triggeredBy:o}};this.dispatchEvent(new CustomEvent(this.constructor.eventBeforeClose,e))&&(this.open=!1,this.dispatchEvent(new CustomEvent(this.constructor.eventClose,e)))}}_handleSlotChange(){this.querySelector(`${e}-modal-footer`)?this.setAttribute("has-footer",""):this.removeAttribute("has-footer")}firstUpdated(){if(!this.querySelector(this.constructor.selectorModalBody)){const o=document.createElement(this.constructor.selectorModalBody);this.appendChild(o)}}render(){const{alert:o,ariaLabel:s,size:r,hasScrollingContent:d}=this,a=this.containerClass.split(" ").filter(Boolean).reduce(((o,e)=>Object.assign(Object.assign({},o),{[e]:!0})),{}),n=c(Object.assign({[`${e}--modal-container`]:!0,[`${e}--modal-container--${r}`]:r},a));return t`
      <a
        id="start-sentinel"
      ...
      <div
        ...
        ${d?t` <div class="cds--modal-content--overflow-indicator"></div> `:""}
      </div>
      <a
        id="end-sentinel"
        class="${e}--visually-hidden"
        href="javascript:void 0"
        role="navigation"></a>
    `}async updated(o){if(o.has("open"))if(this.open){this._launcher=this.ownerDocument.activeElement;const o=this.querySelector(this.constructor.selectorPrimaryFocus);await this.constructor._delay(),o?o.focus():_(this.querySelectorAll(this.constructor.selectorTabbable),!0)||this.focus()}else this._launcher&&"function"==typeof this._launcher.focus&&(this._launcher.focus(),this._launcher=null)}static _delay(o=0){return new Promise((e=>{setTimeout(e,o)}))}static get selectorCloseButton(){return`[data-modal-close],${e}-modal-close-button`}static get selectorTabbable(){return s}static get selectorPrimaryFocus(){return`[data-modal-primary-focus],${e}-modal-footer ${e}-button[kind="primary"]`}static get selectorModalBody(){return`${e}-modal-body`}static get eventBeforeClose(){return`${e}-modal-beingclosed`}static get eventClose(){return`${e}-modal-closed`}};z.styles=f,r([n("#start-sentinel")],z.prototype,"_startSentinelNode",void 0),r([n("#end-sentinel")],z.prototype,"_endSentinelNode",void 0),r([l("click")],z.prototype,"_handleClick",void 0),r([l("shadowRoot:focusout")],z.prototype,"_handleBlur",void 0),r([l("document:keydown")],z.prototype,"_handleKeydown",void 0),r([a({type:Boolean,reflect:!0})],z.prototype,"alert",void 0),r([a({attribute:"aria-label"})],z.prototype,"ariaLabel",void 0),r([a({attribute:"container-class"})],z.prototype,"containerClass",void 0),r([a({type:Boolean,reflect:!0,attribute:"full-width"})],z.prototype,"fullWidth",void 0),r([a({type:Boolean,reflect:!0,attribute:"has-scrolling-content"})],z.prototype,"hasScrollingContent",void 0),r([a({type:Boolean,reflect:!0})],z.prototype,"open",void 0),r([a({reflect:!0})],z.prototype,"size",void 0),r([a({type:Boolean,attribute:"prevent-close-on-click-outside"})],z.prototype,"preventCloseOnClickOutside",void 0),r([a({type:Boolean,attribute:"prevent-close"})],z.prototype,"preventClose",void 0),z=r([p(`${e}-modal`)],z);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let k=class extends d{render(){return t` <slot></slot> `}};k.styles=f,k=r([p(`${e}-modal-body`)],k);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let w=class extends d{render(){return t`<slot></slot>`}};w.styles=f,w=r([p(`${e}-modal-body-content`)],w);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let C=class extends(m(d)){constructor(){super(...arguments),this.closeButtonLabel="Close"}updated(){var o;null===(o=this.parentElement)||void 0===o||o.setAttribute("close-button","")}render(){const{closeButtonLabel:o}=this;return t`
      <button
        part="button"
        aria-label="${b(o)}"
        class="${e}--modal-close"
        title="${b(o)}">
        ${v({part:"close-icon",class:`${e}--modal-close__icon`})}
      </button>
    `}};C.shadowRootOptions=Object.assign(Object.assign({},d.shadowRootOptions),{delegatesFocus:!0}),C.styles=f,r([a({attribute:"close-button-label"})],C.prototype,"closeButtonLabel",void 0),C=r([p(`${e}-modal-close-button`)],C);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let $=class extends d{constructor(){super(...arguments),this.hasThreeButtons=!1}_handleSlotChange(o){const{selectorButtons:e}=this.constructor;this.hasThreeButtons=o.target.assignedNodes().filter((o=>o.nodeType===Node.ELEMENT_NODE&&o.matches(e))).length>2,this.requestUpdate()}render(){return t` <slot @slotchange="${this._handleSlotChange}"></slot> `}static get selectorButtons(){return`${e}-button,${e}-modal-footer-button`}};$.styles=f,r([a({type:Boolean,reflect:!0,attribute:"has-three-buttons"})],$.prototype,"hasThreeButtons",void 0),$=r([p(`${e}-modal-footer`)],$);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let O=class extends u{};O.styles=[h,f],O=r([p(`${e}-modal-footer-button`)],O);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let B=class extends d{constructor(){super(...arguments),this._hasAILabel=!1}_handleSlotChange({target:o}){const e=o.assignedNodes().filter((o=>void 0!==o.matches&&(o.matches(this.constructor.aiLabelItem)||o.matches(this.constructor.slugItem))));e.length>0&&(this._hasAILabel=Boolean(e),e[0].setAttribute("size","sm")),this.requestUpdate()}updated(){var o,e;this._hasAILabel?null===(o=this.parentElement)||void 0===o||o.setAttribute("ai-label",""):null===(e=this.parentElement)||void 0===e||e.removeAttribute("ai-label")}render(){return t` <slot></slot>
      <slot name="ai-label" @slotchange="${this._handleSlotChange}"></slot>
      <slot name="slug" @slotchange="${this._handleSlotChange}"></slot>`}static get slugItem(){return`${e}-slug`}static get aiLabelItem(){return`${e}-ai-label`}};B.styles=f,B=r([p(`${e}-modal-header`)],B);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let E=class extends d{render(){return t` <slot></slot> `}};E.styles=f,E=r([p(`${e}-modal-heading`)],E);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let N=class extends d{render(){return t` <slot></slot> `}};N.styles=f,N=r([p(`${e}-modal-label`)],N);
