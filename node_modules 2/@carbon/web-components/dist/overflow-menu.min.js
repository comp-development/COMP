...
import{i as o,p as e,x as t,_ as r,s}from"./settings-1096a273.js";import{n}from"./property-8bf17a69.js";import{H as c,a as d}from"./host-listener-69c546a1.js";import{F as i}from"./focus-a50a0482.js";import{b as a,i as p}from"./collection-helpers-8b117611.js";import{C as l}from"./icon-button-3c7e5c61.js";import{c as v}from"./carbon-element-017b212d.js";import{C as b,F as u}from"./floating-menu-a018a2a8.js";import"./on-8707857f.js";import"./tooltip-content-8c7333b6.js";import"./popover-content-f8458b22.js";import"./class-map-f136ab55.js";import"./directive-e2d48b9c.js";import"./query-602de8af.js";import"./popover-controller-c3634b83.js";import"./button-7c58436e.js";import"./if-defined-7d77967b.js";import"./button-set-9c90b997.js";import"./button-skeleton-c4243201.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let h=class extends(c(i(l))){constructor(){super(...arguments),this._menuBody=null,this._handleClickTrigger=async()=>{this._handleUserInitiatedToggle()},this._handleKeydownTrigger=async o=>{" "!==o.key&&"Enter"!==o.key||(this._handleUserInitiatedToggle(),o.preventDefault())},this.dataTable=!1,this.disabled=!1,this.flipped=!1,this.open=!1,this.index=1,this.size=f.MEDIUM,this.toolbarAction=!1}async _handleUserInitiatedToggle(){this.open=!this.open;const{index:o,open:t,updateComplete:r}=this;if(t){await r;const{_menuBody:t}=this,s=null==t?void 0:t.querySelector(`${e}-overflow-menu-item:nth-of-type(${o})`);null==s||s.focus()}}get triggerPosition(){return this.getBoundingClientRect()}connectedCallback(){this.hasAttribute("aria-haspopup")||this.setAttribute("aria-haspopup","true"),this.shadowRoot||this.attachShadow({mode:"open"}),super.connectedCallback()}updated(o){var t,r,s,n,c,d,i;const p=null===(r=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(`${e}-tooltip`))||void 0===r?void 0:r.querySelector("button");if(null==p||p.classList.add(`${e}--btn--icon-only`,`${e}--overflow-menu`),o.has("open")){const{open:o}=this;o&&!this._menuBody&&(this._menuBody=a(this.childNodes,(o=>o.constructor.FLOATING_MENU)));const{_menuBody:e}=this;if(e){e.open=o;const t=null===(s=this.querySelector("[slot=tooltip-content]"))||void 0===s?void 0:s.textContent;null==p||p.setAttribute("aria-expanded",String(Boolean(o))),null==p||p.setAttribute("aria-label",String(t))}}if(o.has("dataTable")){const o=null===(n=this.shadowRoot)||void 0===n?void 0:n.querySelector(`${e}-tooltip`);null==o||o.setAttribute("data-table","")}if(o.has("size")){const{size:o}=this,{_menuBody:t}=this;t&&(t.size=o),null==p||p.classList.forEach((o=>{o.startsWith(`${e}--overflow-menu--`)&&(null==p||p.classList.remove(o))})),null==p||p.classList.add(`${e}--overflow-menu--${this.size}`);const r=null===(c=this.shadowRoot)||void 0===c?void 0:c.querySelector(`${e}-tooltip`);null==r||r.setAttribute("size",this.size)}o.has("toolbarAction")&&this.toolbarAction&&(null===(i=null===(d=this.shadowRoot)||void 0===d?void 0:d.querySelector(`${e}-tooltip`))||void 0===i||i.setAttribute("toolbar-action","")),super.updated(o)}render(){return t` ${super.render()} `}};h.styles=g,r([d("click")],h.prototype,"_handleClickTrigger",void 0),r([d("keydown")],h.prototype,"_handleKeydownTrigger",void 0),r([n({type:Boolean,reflect:!0,attribute:"data-table"})],h.prototype,"dataTable",void 0),r([n({type:Boolean,reflect:!0})],h.prototype,"disabled",void 0),r([n({type:Boolean,reflect:!0})],h.prototype,"flipped",void 0),r([n({type:Boolean,reflect:!0})],h.prototype,"open",void 0),r([n()],h.prototype,"index",void 0),r([n({reflect:!0})],h.prototype,"size",void 0),r([n({type:Boolean,attribute:"toolbar-action",reflect:!0})],h.prototype,"toolbarAction",void 0),h=r([v(`${e}-overflow-menu`)],h);let y=class extends b{constructor(){super(...arguments),this.direction=u.BOTTOM,this.flipped=!1,this.open=!1,this.selected=null,this.size=f.MEDIUM,this._handleKeydown=async o=>{const{key:e}=o;this.open&&(this.contains(document.activeElement)&&(this.selected=document.activeElement),e in m&&this._navigate(m[e]),"Escape"===e&&(this.open=!1))}}_getNextItem(o,e){const{selectorItemEnabled:t}=this.constructor,r=this.querySelectorAll(t),s=p(r,o),n=(c=s+e,d=r.length,c<0?d-1:c>=d?0:c);var c,d;return n===s?null:r[n]}_navigate(o){if(this.selected){const e=this._getNextItem(this.selected,o);null==e||e.focus()}}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","menu"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","-1"),super.connectedCallback()}updated(o){if(o.has("size")){const{selectorMenuItem:o}=this.constructor;this.querySelectorAll(o).forEach((o=>{o.setAttribute("size",this.size)}))}super.updated(o)}render(){return t` <slot></slot> `}static get selectorMenuItem(){return`${e}-overflow-menu-item`}static get selectorItemEnabled(){return`${e}-overflow-menu-item:not([disabled])`}};y.styles=g,r([n()],y.prototype,"direction",void 0),r([n({type:Boolean,reflect:!0})],y.prototype,"flipped",void 0),r([n({type:Boolean,reflect:!0})],y.prototype,"open",void 0),r([n({reflect:!0})],y.prototype,"size",void 0),r([d("keydown")],y.prototype,"_handleKeydown",void 0),y=r([v(`${e}-overflow-menu-body`)],y);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let w=class extends(i(s)){constructor(){super(...arguments),this.danger=!1,this.disabled=!1,this.divider=!1,this.href="",this.size=f.MEDIUM}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","menuitem"),super.connectedCallback()}render(){return this.href?t`
          <a
        ...
        `}};w.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),w.styles=g,r([n({type:Boolean,reflect:!0})],w.prototype,"danger",void 0),r([n({type:Boolean,reflect:!0})],w.prototype,"disabled",void 0),r([n({type:Boolean,reflect:!0})],w.prototype,"divider",void 0),r([n()],w.prototype,"href",void 0),r([n({reflect:!0})],w.prototype,"size",void 0),w=r([v(`${e}-overflow-menu-item`)],w);
