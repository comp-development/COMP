...
import{i as t,p as s,x as e,_ as o,s as a}from"./settings-1096a273.js";import{n as c}from"./property-8bf17a69.js";import{N as n,C as d,a as r}from"./content-switcher-item-b836be1f.js";import{r as i}from"./state-16f7c070.js";import{e as l}from"./query-602de8af.js";import{e as b}from"./class-map-f136ab55.js";import{H as v,a as p}from"./host-listener-69c546a1.js";import{f as h}from"./collection-helpers-8b117611.js";import{s as u}from"./16-1d873b4f.js";import{s as f}from"./16-9501e226.js";import{c as g}from"./carbon-element-017b212d.js";import"./if-defined-7d77967b.js";import"./focus-a50a0482.js";import"./directive-e2d48b9c.js";import"./on-8707857f.js";import"./spread-c3902148.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let k=class extends(v(d)){constructor(){super(...arguments),this._currentIndex=0,this._totalTabs=0,this._isScrollable=!1,this.tablist=null,this.BUTTON_WIDTH=44,this._currentScrollPosition=0,this.selectingItemsAssistiveText="Selecting items. Use up and down arrow keys to navigate.",this.selectedItemAssistiveText="Selected an item.",this.triggerContent="",this.type=m.REGULAR,this._isIntersectionLeftTrackerInContent=!0,this._isIntersectionRightTrackerInContent=!0,this._observerIntersection=null,this._observeIntersectionContainer=t=>{const{_intersectionLeftSentinelNode:s,_intersectionRightSentinelNode:e}=this;t.forEach((({isIntersecting:t,target:o})=>{o===s&&(this._isIntersectionLeftTrackerInContent=t),o===e&&(this._isIntersectionRightTrackerInContent=t)}))}}_navigate(t,{immediate:s=!0}={}){const{selectorItem:e,selectorItemHighlighted:o,selectorItemSelected:a}=this.constructor,c=this._getNextItem(this.querySelector(s?a:o),t);if(!c)return;s?this._handleUserInitiatedSelectItem(c):h(this.querySelectorAll(e),(t=>{t[s?"selected":"highlighted"]=c===t})),c.scrollIntoView({block:"nearest",inline:"nearest"});const n=c.textContent;n&&(this._assistiveStatusText=n),this._currentIndex+=t,this.requestUpdate()}_handleClick(t){super._handleClick(t)}_handleKeydown(t){const{key:e}=t,o=this.constructor.getAction(e),a=this.querySelectorAll(`${s}-tab:not([disabled])`);switch(o){case _.HOME:{const[t]=a;t.scrollIntoView({block:"nearest",inline:"nearest"}),this._handleUserInitiatedSelectItem(t),this.requestUpdate()}break;case _.END:{const t=a[a.length-1];t.scrollIntoView({block:"nearest",inline:"nearest"}),this._handleUserInitiatedSelectItem(t),this.requestUpdate()}break;case _.NAVIGATING:{const t=n[e];t&&this._navigate(t)}}}_handleScrollButtonClick(t,{direction:s}){if(!this.tablist)return;const{scrollLeft:e,clientWidth:o,scrollWidth:a}=this._contentContainerNode;switch(s){case-1:this._contentContainerNode.scrollLeft=Math.max(e-a/this._totalTabs*1.5,0);break;case 1:this._contentContainerNode.scrollLeft=Math.min(e+a/this._totalTabs*1.5,a-o)+1}}_handleSlotchange(){const{selectorItemSelected:t}=this.constructor,s=this.querySelector(t);this._getNextItem(s,1).hideDivider=!0}_selectionDidChange(t){super._selectionDidChange(t),this._assistiveStatusText=this.selectedItemAssistiveText}_cleanAndCreateIntersectionObserverContainer({create:t}={}){const{_intersectionLeftSentinelNode:s,_intersectionRightSentinelNode:e}=this;this._observerIntersection&&(this._observerIntersection.disconnect(),this._observerIntersection=null),t&&(this._observerIntersection=new IntersectionObserver(this._observeIntersectionContainer,{root:this,threshold:0}),s&&this._observerIntersection.observe(s),e&&this._observerIntersection.observe(e))}disconnectedCallback(){this._cleanAndCreateIntersectionObserverContainer(),super.disconnectedCallback()}shouldUpdate(t){if(super.shouldUpdate(t),this.tablist){const{clientWidth:t,scrollWidth:s}=this.tablist;this._isScrollable=s>t}const{selectorItem:s}=this.constructor;return t.has("type")&&h(this.querySelectorAll(s),(t=>{this._totalTabs++,t.type=this.type})),!0}firstUpdated(){const{selectorTablist:t}=this.constructor,s=this.shadowRoot.querySelector(t);this.tablist=s,this._cleanAndCreateIntersectionObserverContainer({create:!0})}updated(t){var e,o;if(t.has("value")){const t=this.querySelector(`${s}-tab[value="${this.value}"]`);if(t){const{width:s}=null!==(e=null==t?void 0:t.getBoundingClientRect())&&void 0!==e?e:{},a=null!==(o=t.offsetLeft)&&void 0!==o?o:0,c=t.offsetLeft+s,n=this.tablist.scrollLeft+this.BUTTON_WIDTH,d=this.tablist.scrollLeft+this.tablist.clientWidth-this.BUTTON_WIDTH;a<n&&(this.tablist.scrollLeft=a-this.BUTTON_WIDTH),c>d&&(this.tablist.scrollLeft=c+this.BUTTON_WIDTH-this.tablist.clientWidth)}}t.has("_currentScrollPosition")&&this._contentNode&&(this._contentNode.style.insetInlineStart=`-${this._currentScrollPosition}px`)}renderPreviousButton(){const{_isIntersectionLeftTrackerInContent:t}=this,o=b({[`${s}--tab--overflow-nav-button`]:!0,[`${s}--tabs__nav-caret-left`]:!0,[`${s}--tab--overflow-nav-button--previous`]:!0,[`${s}--tab--overflow-nav-button--hidden`]:t});return e`
      <button
        part="prev-button"
        tabindex="-1"
        aria-hidden="true"
    ...
    `}renderNextButton(){const{_isIntersectionRightTrackerInContent:t}=this,o=b({[`${s}--tab--overflow-nav-button`]:!0,[`${s}--tabs__nav-caret-right`]:!0,[`${s}--tab--overflow-nav-button--next`]:!0,[`${s}--tab--overflow-nav-button--hidden`]:t});return e`
      <button
        part="next-button"
        tabindex="-1"
        aria-hidden="true"
    ...
    `}render(){const{_assistiveStatusText:t,_handleSlotchange:o}=this;return e`
      ${this.renderPreviousButton()}
      <div class="${s}--tabs-nav-content-container">
        <div class="${s}--tabs-nav-content">
          <div class="${s}--tabs-nav">
            <div id="tablist" role="tablist" class="${s}--tab--list">
              <div class="${s}--sub-content-left"></div>
              <slot @slotchange=${o}></slot>
              <div class="${s}--sub-content-right"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        class="${s}--assistive-text"
        role="status"
        aria-live="assertive"
        aria-relevant="additions text">
        ${t}
      </div>
    `}static get selectorItem(){return`${s}-tab`}static get selectorItemEnabled(){return`${s}-tab:not([disabled])`}static get selectorItemHighlighted(){return`${s}-tab[highlighted]`}static get selectorItemSelected(){return`${s}-tab[selected]`}static get selectorTablist(){return`.${s}--tab--list`}static get eventBeforeSelect(){return`${s}-tabs-beingselected`}static get eventSelect(){return`${s}-tabs-selected`}static getAction(t){return"Home"===t?_.HOME:"End"===t?_.END:t in n?_.NAVIGATING:_.NONE}};k.TRIGGER_KEYS=new Set([" ","Enter"]),k.styles=y,o([p("click")],k.prototype,"_handleClick",null),o([p("keydown")],k.prototype,"_handleKeydown",null),o([l(`.${s}--tabs-nav-content-container`)],k.prototype,"_contentContainerNode",void 0),o([l(`.${s}--tabs-nav-content`)],k.prototype,"_contentNode",void 0),o([i()],k.prototype,"_currentScrollPosition",void 0),o([l(`.${s}--sub-content-left`)],k.prototype,"_intersectionLeftSentinelNode",void 0),o([l(`.${s}--sub-content-right`)],k.prototype,"_intersectionRightSentinelNode",void 0),o([c({attribute:"selecting-items-assistive-text"})],k.prototype,"selectingItemsAssistiveText",void 0),o([c({attribute:"selected-item-assistive-text"})],k.prototype,"selectedItemAssistiveText",void 0),o([c({attribute:"trigger-content"})],k.prototype,"triggerContent",void 0),o([c({reflect:!0})],k.prototype,"type",void 0),o([i()],k.prototype,"_isIntersectionLeftTrackerInContent",void 0),o([i()],k.prototype,"_isIntersectionRightTrackerInContent",void 0),k=o([g(`${s}-tabs`)],k);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let x=class extends r{constructor(){super(...arguments),this.highlighted=!1,this.type=m.REGULAR}_handleSlotChange({target:t}){const s=t.assignedNodes();this.tabTitle=s[0].textContent}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{disabled:t,selected:o,tabTitle:a,_handleSlotChange:c}=this;return e`
      <a
        class="${s}--tabs__nav-link"
        role="tab"
        aria-label="${a}"
        tabindex="${o?0:-1}"
        ?disabled="${t}"
    ...
    `}};x.styles=y,o([c({type:Boolean,reflect:!0})],x.prototype,"highlighted",void 0),o([c({reflect:!0})],x.prototype,"type",void 0),o([c()],x.prototype,"tabTitle",void 0),x=o([g(`${s}-tab`)],x);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends a{render(){return e` <div class="${s}--tabs__nav-link"></div> `}};z.styles=y,z=o([g(`${s}-tab-skeleton`)],z);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let w=class extends a{render(){return e`
      <div class="${s}--tabs-trigger">
        <span class="${s}--tabs-trigger-text"></span>
      </div>
      <ul class="${s}--tabs__nav">
        <slot></slot>
      </ul>
    `}};w.styles=y,w=o([g(`${s}-tabs-skeleton`)],w);
