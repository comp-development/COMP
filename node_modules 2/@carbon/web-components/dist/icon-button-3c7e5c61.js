...
import{i as o,_ as t,p as e,x as s}from"./settings-1096a273.js";import{n as p}from"./property-8bf17a69.js";import{c}from"./carbon-element-017b212d.js";import"./tooltip-content-8c7333b6.js";import{C as n}from"./button-7c58436e.js";import"./button-set-9c90b997.js";import"./button-skeleton-c4243201.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let a=class extends n{constructor(){super(...arguments),this.align="top",this.autoalign=!1,this.closeOnActivation=!0,this.defaultOpen=!1,this.enterDelayMs=100,this.leaveDelayMs=300,this.size="md"}updated(o){var t,s,p,c,n,r,d,i;if(o){null===(c=null===(p=null===(s=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(`${e}-tooltip`))||void 0===s?void 0:s.shadowRoot)||void 0===p?void 0:p.querySelector(`.${e}--tooltip`))||void 0===c||c.classList.add(`${e}--icon-tooltip`);const o=null===(n=this.querySelector("[slot=tooltip-content]"))||void 0===n?void 0:n.textContent;null===(i=null===(d=null===(r=this.shadowRoot)||void 0===r?void 0:r.querySelector(`${e}-tooltip`))||void 0===d?void 0:d.querySelector("button"))||void 0===i||i.setAttribute("aria-label",String(o))}}_renderTooltipContent(){return s`
      <cds-tooltip-content>
        <slot name="tooltip-content"></slot>
      </cds-tooltip-content>
    `}render(){const{align:o,autoalign:t,closeOnActivation:e,defaultOpen:p,enterDelayMs:c,leaveDelayMs:n}=this;return s`
      <cds-tooltip
        ?autoalign=${t}
        align=${o}
        ?defaultOpen=${p}
        close-on-activation="${e}"
        enter-delay-ms=${c}
        leave-delay-ms=${n}>
        ${super.render()} ${this._renderTooltipContent()}
      </cds-tooltip>
    `}};a.styles=i,t([p({reflect:!0,type:String})],a.prototype,"align",void 0),t([p({type:Boolean,reflect:!0})],a.prototype,"autoalign",void 0),t([p({attribute:"close-on-activation",reflect:!0,type:Boolean})],a.prototype,"closeOnActivation",void 0),t([p({reflect:!0,type:Boolean})],a.prototype,"defaultOpen",void 0),t([p({attribute:"enter-delay-ms",type:Number})],a.prototype,"enterDelayMs",void 0),t([p({attribute:"leave-delay-ms",type:Number})],a.prototype,"leaveDelayMs",void 0),t([p({reflect:!0})],a.prototype,"size",void 0),a=t([c(`${e}-icon-button`)],a);var l=a;export{l as C};
