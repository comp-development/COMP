 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let i=class extends(s(r)){constructor(){super(...arguments),this.align="top",this.autoalign=!1,this.dataTable=!1,this.closeOnActivation=!1,this.defaultOpen=!1,this.enterDelayMs=100,this.leaveDelayMs=300,this.size=!1,this.timeoutId=0,this.toolbarAction=!1,this._handleHover=async()=>{window.clearTimeout(this.timeoutId),this.timeoutId=window.setTimeout((async()=>{var o;this.open=!0;const{open:t,updateComplete:e}=this;if(t){await e;const{selectorTooltipContent:t}=this.constructor;null===(o=this.querySelector(t))||void 0===o||o.focus()}}),this.enterDelayMs)},this._handleHoverOut=async()=>{window.clearTimeout(this.timeoutId),this.timeoutId=window.setTimeout((async()=>{const{open:o}=this;o&&(this.open=!1)}),this.leaveDelayMs)},this._handleClick=async()=>{this.closeOnActivation&&this._handleHoverOut()},this._handleKeydown=async o=>{" "!==o.key&&"Enter"!==o.key&&"Escape"!==o.key||this._handleHoverOut()}}_handleSlotChange({target:o}){const t=o.assignedNodes().filter((o=>o.nodeType!==Node.TEXT_NODE||o.textContent.trim()));t[0]&&(t[0].addEventListener("focus",this._handleHover),t[0].addEventListener("focusout",this._handleHoverOut),t[0].addEventListener("mouseover",this._handleHover),t[0].addEventListener("mouseleave",this._handleHoverOut),this.requestUpdate())}connectedCallback(){this.hasAttribute("highContrast")||this.setAttribute("highContrast",""),this.shadowRoot||this.attachShadow({mode:"open"}),super.connectedCallback()}updated(o){var e,p;const{selectorTooltipContent:s}=this.constructor,c=this.querySelector(s);o.has("defaultOpen")&&(this.open=this.defaultOpen),o.has("open")&&(this.open?null==c||c.setAttribute("open",""):null==c||c.removeAttribute("open")),["align","caret","autoalign"].forEach((t=>{if(o.has(t)){const{[t]:o}=this;c[t]=o}})),null===(p=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(`.${t}--popover-container`))||void 0===p||p.classList.add(`${t}--tooltip`),super.updated(o)}static get selectorTooltipContent(){return`${t}-tooltip-content`}static get styles(){return o`
      ${super.styles}${a}
    `}};e([p({reflect:!0,type:String})],i.prototype,"align",void 0),e([p({type:Boolean,reflect:!0})],i.prototype,"autoalign",void 0),e([p({type:Boolean,reflect:!0,attribute:"data-table"})],i.prototype,"dataTable",void 0),e([p({reflect:!0,type:Boolean})],i.prototype,"closeOnActivation",void 0),e([p({reflect:!0,type:Boolean})],i.prototype,"defaultOpen",void 0),e([p({attribute:"enter-delay-ms",type:Number})],i.prototype,"enterDelayMs",void 0),e([p({attribute:"leave-delay-ms",type:Number})],i.prototype,"leaveDelayMs",void 0),e([p({reflect:!0})],i.prototype,"size",void 0),e([p({reflect:!0})],i.prototype,"timeoutId",void 0),e([p({reflect:!0,attribute:"toolbar-action",type:Boolean})],i.prototype,"toolbarAction",void 0),e([c("click")],i.prototype,"_handleClick",void 0),e([c("click")],i.prototype,"_handleKeydown",void 0),i=e([d(`${t}-tooltip`)],i);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends n{connectedCallback(){this.hasAttribute("aria-hidden")||this.setAttribute("aria-hidden","true"),this.hasAttribute("role")||this.setAttribute("role","tooltip"),super.connectedCallback()}updated(){var o,e;null===(e=null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector(`.${t}--popover-content`))||void 0===e||e.classList.add(`${t}--tooltip-content`)}};v.styles=a,v=e([d(`${t}-tooltip-content`)],v);
