...
import{_ as e,s as t,p as s,i as l,x as i}from"./settings-1096a273.js";import{n as r}from"./property-8bf17a69.js";import{c}from"./carbon-element-017b212d.js";import{e as a}from"./query-602de8af.js";import{e as d}from"./class-map-f136ab55.js";import{s as o}from"./16-66567a49.js";import{s as n}from"./16-d83d40a3.js";import{s as p}from"./16-635eac8f.js";import{o as u}from"./if-defined-7d77967b.js";import{F as b}from"./form-a750a2ac.js";import{c as f}from"./collection-helpers-8b117611.js";import{I as m}from"./text-input-c528de80.js";import{i as v}from"./if-non-empty-09760ce1.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let _=class extends(b(t)){constructor(){super(...arguments),this._hasAILabel=!1,this._observerMutation=null,this._placeholderItemValue=`__${s}-select-placeholder_${Math.random().toString(36).slice(2)}`,this._handleMutation=()=>{this.requestUpdate()},this.autofocus=!1,this.disabled=!1,this.helperText="",this.hideLabel=!1,this.id="",this.invalid=!1,this.invalidText="",this.warn=!1,this.warnText="",this.labelText="",this.inline=!1,this.name="",this.pattern="",this.placeholder="",this.readonly=!1,this.required=!1,this.requiredValidityMessage="Please fill out this field.",this.size=m.MEDIUM,this.value=""}_handleInput({target:e}){const{value:t}=e;this.value=t;const{eventSelect:s}=this.constructor;this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0,detail:{value:t}}))}_renderItems(e){const{selectorItem:t,selectorLeafItem:l}=this.constructor;return i`
      ${f(e.childNodes,(e=>e.nodeType===Node.ELEMENT_NODE&&e.matches(t))).map((e=>{const t=e.hasAttribute("disabled"),r=e.getAttribute("label"),c=e.hasAttribute("selected"),a=e.getAttribute("value"),{textContent:d}=e;return e.matches(l)?i`
              <option
            ...
            `:i`
              <optgroup
                class="${s}--select-optgroup"
                ?disabled="${t}"
                label="${u(r)}">
                ${this._renderItems(e)}
              </optgroup>
            `}))}
    `}_handleFormdata(e){const{formData:t}=e,{disabled:s,name:l,value:i}=this;s||t.append(l,i)}_handleAILabelSlotChange({target:e}){const t=e.assignedNodes().filter((e=>void 0!==e.matches&&(e.matches(this.constructor.aiLabelItem)||e.matches(this.constructor.slugItem))));this._hasAILabel=Boolean(t),t[0].setAttribute("size","mini"),this.requestUpdate()}get length(){return this._selectNode.length}get options(){return this._selectNode.options}get type(){return this._selectNode.type}get multiple(){return!1}get selectedIndex(){var e;return null===(e=this._selectNode)||void 0===e?void 0:e.selectedIndex}set selectedIndex(e){this._selectNode.selectedIndex=e,this.value=this._selectNode.value}connectedCallback(){super.connectedCallback(),this._observerMutation=new MutationObserver(this._handleMutation),this._observerMutation.observe(this,{attributes:!0,childList:!0,subtree:!0})}disconnectedCallback(){this._observerMutation&&(this._observerMutation.disconnect(),this._observerMutation=null),super.disconnectedCallback()}updated(e){var t,l,i,r,c;if(e.has("value")){const{value:e,_placeholderItemValue:t}=this;this._selectNode.value=e||t}const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("slot[name='ai-label']");a?null==a||a.classList.toggle(`${s}--slug--revert`,null===(l=this.querySelector(`${s}-ai-label`))||void 0===l?void 0:l.hasAttribute("revert-active")):null===(r=null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector("slot[name='slug']"))||void 0===r||r.classList.toggle(`${s}--slug--revert`,null===(c=this.querySelector(`${s}-slug`))||void 0===c?void 0:c.hasAttribute("revert-active"))}render(){const{disabled:e,helperText:t,hideLabel:l,inline:r,invalid:c,invalidText:a,labelText:b,placeholder:f,readonly:m,size:v,warn:g,warnText:h,value:_,_placeholderItemValue:y,_handleInput:x,_handleAILabelSlotChange:w,_hasAILabel:k}=this,$=d({[`${s}--select`]:!0,[`${s}--select--inline`]:r,[`${s}--select--invalid`]:c,[`${s}--select--warning`]:g,[`${s}--select--disabled`]:e,[`${s}--select--readonly`]:m,[`${s}--select--slug`]:k}),z=d({[`${s}--select-input`]:!0,[`${s}--select-input--${v}`]:v}),q=d({[`${s}--label`]:!0,[`${s}--label--disabled`]:e}),I=d({[`${s}--form__helper-text`]:!0,[`${s}--form__helper-text--disabled`]:e}),S=t?i`
          <div class="${I}">
            <slot name="helper-text"> ${t} </slot>
          </div>
        `:null,M=c||g?i` <div class="${s}--form-requirement">
            ${c?a:h}
          </div>`:null,B=i`
      <select
        id="input"
        class="${z}"
        ?disabled="${e}"
        aria-readonly="${String(Boolean(m))}"
        aria-invalid="${String(Boolean(c))}"
        aria-describedby="${u(c?"invalid-text":void 0)}"
        @input="${x}">
        ${!f||_?void 0:i`
              <option
                disabled
      ...
      ${o({class:`${s}--select__arrow`})}
      <slot name="ai-label" @slotchange=${w}></slot>
      <slot name="slug" @slotchange=${w}></slot>
      ${c?n({class:`${s}--select__invalid-icon`}):void 0}
      ${!c&&g?p({class:`${s}--select__invalid-icon ${s}--select__invalid-icon--warning`}):null}
    `;return i`
      <div class="${$}">
        ${l?null:i`<label class="${q}" for="input">
              <slot name="label-text"> ${b} </slot>
            </label>`}
        ${r?i`<div class="${s}--select-input--inline__wrapper">
              <div
                class="${s}--select-input__wrapper"
                ?data-invalid="${c}">
                ${B}
              </div>
              ${M}
    ...
    `}static get selectorItem(){return`${s}-select-item-group,${s}-select-item`}static get selectorLeafItem(){return`${s}-select-item`}static get slugItem(){return`${s}-slug`}static get aiLabelItem(){return`${s}-ai-label`}static get eventSelect(){return`${s}-select-selected`}};_.shadowRootOptions=Object.assign(Object.assign({},t.shadowRootOptions),{delegatesFocus:!0}),_.styles=h,e([a("select")],_.prototype,"_selectNode",void 0),e([r({type:Boolean})],_.prototype,"autofocus",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"disabled",void 0),e([r({attribute:"helper-text"})],_.prototype,"helperText",void 0),e([r({type:Boolean,attribute:"hide-label"})],_.prototype,"hideLabel",void 0),e([r()],_.prototype,"id",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"invalid",void 0),e([r({attribute:"invalid-text"})],_.prototype,"invalidText",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"warn",void 0),e([r({attribute:"warn-text"})],_.prototype,"warnText",void 0),e([r({attribute:"label-text"})],_.prototype,"labelText",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"inline",void 0),e([r({type:Boolean})],_.prototype,"multiple",null),e([r()],_.prototype,"name",void 0),e([r()],_.prototype,"pattern",void 0),e([r({reflect:!0})],_.prototype,"placeholder",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"readonly",void 0),e([r({type:Boolean,reflect:!0})],_.prototype,"required",void 0),e([r({attribute:"required-validity-message"})],_.prototype,"requiredValidityMessage",void 0),e([r({type:Number})],_.prototype,"selectedIndex",null),e([r({reflect:!0})],_.prototype,"size",void 0),e([r({reflect:!0})],_.prototype,"value",void 0),_=e([c(`${s}-select`)],_);export{h as s};
