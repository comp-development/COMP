 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let p=class extends(n(o)){constructor(){super(...arguments),this.linkAssisstiveText="Skip to main content"}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}render(){const{linkAssisstiveText:e}=this;return r`
      <a class="${s}--skip-to-content" href="${d(this.href)}"
        ><slot>${e}</slot></a
      >
    `}updated(e){if(e.has("linkAssisstiveText")){const{linkAssisstiveText:e}=this;this.setAttribute("aria-label",e)}}};p.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),p.styles=i,t([c({attribute:"link-assistive-text"})],p.prototype,"linkAssisstiveText",void 0),t([c()],p.prototype,"href",void 0),p=t([a(`${s}-skip-to-content`)],p);
