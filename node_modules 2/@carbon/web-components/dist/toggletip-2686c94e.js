...
import{b as o,i as t,x as e,p,s,_ as c}from"./settings-1096a273.js";import{e as r}from"./class-map-f136ab55.js";import{n}from"./property-8bf17a69.js";import{c as d}from"./carbon-element-017b212d.js";import{s as a}from"./spread-c3902148.js";import{H as i,a as l}from"./host-listener-69c546a1.js";import{F as v}from"./focus-a50a0482.js";import{P as h}from"./popover-controller-c3634b83.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let f=b=class extends(i(v(s))){constructor(){super(...arguments),this.popoverController=new h(this),this.alignment=g.TOP,this.autoalign=!1,this.open=!1,this._handleClick=()=>{this.open=!this.open},this._handleKeydown=async o=>{"Escape"===o.key&&(this.open=!1)},this._renderToggleTipLabel=()=>e`
      <span class="${p}--toggletip-label">
        <slot></slot>
      </span>
    `,this._renderTooltipButton=()=>e`
      <button
        aria-controls="${this.id}"
        class="${p}--toggletip-button"
        @click=${this._handleClick}>
        ${(({children:t,...e}={})=>o`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${a(e)}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${t}<path d="M8.5 11L8.5 6.5 6.5 6.5 6.5 7.5 7.5 7.5 7.5 11 6 11 6 12 10 12 10 11zM8 3.5c-.4 0-.8.3-.8.8S7.6 5 8 5c.4 0 .8-.3.8-.8S8.4 3.5 8 3.5z"></path><path d="M8,15c-3.9,0-7-3.1-7-7s3.1-7,7-7s7,3.1,7,7S11.9,15,8,15z M8,2C4.7,2,2,4.7,2,8s2.7,6,6,6s6-2.7,6-6S11.3,2,8,2z"></path></svg>`)({id:"trigger"})}
      </button>
    `,this._renderTooltipContent=()=>this.autoalign?e`
          <span class="${p}--popover-content">
            <div class="${p}--toggletip-content">
              <slot name="body-text"></slot>
              <div class="${p}--toggletip-actions">
                <slot
                  name="actions"
                  @slotchange="${this._handleActionsSlotChange}"></slot>
              </div>
            </div>
            <span class="${p}--popover-caret"></span>
          </span>
        `:e`
        ...
        `,this._renderInnerContent=()=>e`
      ${this._renderTooltipButton()} ${this._renderTooltipContent()}
    `}_handleActionsSlotChange({target:o}){o.assignedNodes()?this.setAttribute("has-actions",""):this.removeAttribute("has-actions")}_handleFocusOut(o){this.contains(o.relatedTarget)||(this.open=!1)}updated(){var o,t,e,p;if(this.autoalign&&this.open){const s=null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector(b.selectorToggletipButton),c=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(b.selectorToggletipContent),r=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(b.selectorToggletipCaret);s&&c&&(null===(p=this.popoverController)||void 0===p||p.setPlacement({trigger:s,target:c,arrowElement:r,caret:!0,flip:!0,alignment:this.alignment}))}}render(){const{alignment:o,open:t}=this,s=r({[`${p}--popover-container`]:!0,[`${p}--popover--caret`]:!0,[`${p}--popover--high-contrast`]:!0,[`${p}--popover--open`]:t,[`${p}--popover--${o}`]:o,[`${p}--toggletip`]:!0,[`${p}--toggletip--open`]:t});return e`
      ${this._renderToggleTipLabel()}
      <span class="${s}">
        ${this._renderInnerContent()}
      </span>
    </span>
    `}static get selectorToggletipContent(){return`.${p}--popover-content`}static get selectorToggletipCaret(){return`.${p}--popover-caret`}static get selectorToggletipButton(){return`.${p}--toggletip-button`}};f.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),f.styles=u,c([n({reflect:!0})],f.prototype,"alignment",void 0),c([n({type:Boolean,reflect:!0})],f.prototype,"autoalign",void 0),c([n({type:Boolean,reflect:!0})],f.prototype,"open",void 0),c([l("keydown")],f.prototype,"_handleKeydown",void 0),c([l("focusout")],f.prototype,"_handleFocusOut",null),f=b=c([d(`${p}-toggletip`)],f);var m=f;export{m as C};
