  ...
  public: {
    Tables: {
      addon_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "addon_orders_addon_id_fk"
            columns: ["addon_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "addon_orders_org_event_id_fk"
          ...
          {
            foreignKeyName: "addon_orders_student_event_id_fk"
            columns: ["student_event_id"]
            isOneToOne: false
            referencedRelation: "student_events"
            referencedColumns: ["student_event_id"]
          },
          {
            foreignKeyName: "addon_orders_team_id_fk"
            columns: ["team_id"]
            isOneToOne: false
      ...
      addons: {
        Row: {
          addon_id: string
          addon_name: string
          addon_table: Database["public"]["Enums"]["entities"]
          created_at: string
      ...
      custom_field_values: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_field_values_event_custom_field_id_fkey"
          ...
          {
            foreignKeyName: "custom_field_values_student_event_id_fkey"
            columns: ["student_event_id"]
            isOneToOne: false
            referencedRelation: "student_events"
            referencedColumns: ["student_event_id"]
          ...
          {
            foreignKeyName: "custom_field_values_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["team_id"]
      ...
      custom_fields: {
        Row: {
          ...
          custom_field_table: Database["public"]["Enums"]["entities"]
          custom_field_type: Database["public"]["Enums"]["custom_field_type"]
          editable: boolean
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "custom_fields_host_id_fkey"
            columns: ["host_id"]
            isOneToOne: false
      ...
      event_custom_fields: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_custom_fields_custom_field_id_fkey"
      ...
      host_admins: {
        ...
        Relationships: [
          {
            foreignKeyName: "host_admins_admin_id_fkey"
            columns: ["admin_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "host_admins_host_id_fkey"
            columns: ["host_id"]
            isOneToOne: false
            referencedRelation: "hosts"
            referencedColumns: ["host_id"]
      ...
      org_coaches: {
        ...
        Relationships: [
          {
            foreignKeyName: "org_coaches_coach_id_fkey"
            columns: ["coach_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "org_coaches_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
    ...
    Enums: {
      ...
      custom_field_type:
        ...
        | "checkboxes"
        | "dropdown"
      entities: "students" | "teams" | "orgs"
      refund_status_enum: "PENDING" | "APPROVED" | "DENIED"
