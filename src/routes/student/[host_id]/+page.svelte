<script lang="ts">
	...
	import { getHostInformation, getHostEvents, getStudentHostEvents } from "$lib/supabase";
...
{:else}
    ...
    <p>More info about this host soon</p>
    <br />
		...
		{#each my_events as event}
			<div>
				<div class="problemContainer">
					...
					<br />
					<div>
						<Button size="sm" href={`./${host_id}/${event.event_id}`} pill>Go to Event</Button>
					</div>
				</div>
			</div>
		{/each}
